...
Noa Server is a complex system with multiple packages, agent coordination, and
integration with various services. We need to decide on the programming language
and type system for the backend.
