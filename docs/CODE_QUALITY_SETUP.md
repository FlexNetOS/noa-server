...
This document provides a comprehensive guide to the code quality tools and security scanning configuration for the Noa Server monorepo.
...
**Purpose**: Exclude generated files, dependencies, and build artifacts from linting/formatting
...
3. Enable EditorConfig: Settings → Editor → Code Style → Enable EditorConfig support
