...
export interface IMainServiceClient {
  ...
  disconnect(
    ...
    options?: RpcOptions
  ): UnaryCall<DisconnectRequest, DisconnectResponse>;
  /**
   ...
   */
  listService(
    input: ListServiceOptions,
    options?: RpcOptions
  ): UnaryCall<ListServiceOptions, ServiceList>;
  /**
   ...
   */
  listNamespace(
    input: ListNamespaceOptions,
    options?: RpcOptions
  ): UnaryCall<ListNamespaceOptions, NamespaceList>;
  /**
   ...
   */
  setServiceConfigs(
    input: SetServiceConfigsRequest,
    options?: RpcOptions
  ): UnaryCall<SetServiceConfigsRequest, SetServiceConfigsResponse>;
}
/**
 * @generated from protobuf service octelium.api.main.user.v1.MainService
 */
export class MainServiceClient implements IMainServiceClient, ServiceInfo {
  ...
  disconnect(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DisconnectRequest, DisconnectResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  listService(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<ListServiceOptions, ServiceList>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  listNamespace(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<ListNamespaceOptions, NamespaceList>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  setServiceConfigs(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<SetServiceConfigsRequest, SetServiceConfigsResponse>(
      'unary',
      this._transport,
      method,
      opt,
