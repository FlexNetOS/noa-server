...
class Metadata$Type extends MessageType<Metadata> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.meta.v1.ObjectReference actorRef */ 13:
          message.actorRef = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.actorRef
  ...
  private binaryReadMap7(
    ...
    let len = reader.uint32(),
      ...
      key: keyof Metadata['labels'] | undefined,
      val: Metadata['labels'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field octelium.api.main.meta.v1.Metadata.labels'
          );
      }
    }
    map[key ?? ''] = val ?? '';
  ...
  private binaryReadMap9(
    map: Metadata['annotations'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof Metadata['annotations'] | undefined,
      val: Metadata['annotations'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field octelium.api.main.meta.v1.Metadata.annotations'
          );
      }
    }
    map[key ?? ''] = val ?? '';
  ...
  private binaryReadMap16(
    map: Metadata['specLabels'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof Metadata['specLabels'] | undefined,
      val: Metadata['specLabels'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field octelium.api.main.meta.v1.Metadata.specLabels'
          );
      }
    }
    map[key ?? ''] = val ?? '';
  ...
  private binaryReadMap19(
    map: Metadata['systemLabels'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof Metadata['systemLabels'] | undefined,
      val: Metadata['systemLabels'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field octelium.api.main.meta.v1.Metadata.systemLabels'
          );
      }
    }
    map[key ?? ''] = val ?? '';
  ...
  internalBinaryWrite(
    ...
    for (let k of globalThis.Object.keys(message.annotations))
      writer
        ...
        .join();
    /* string picURL = 10; */
    if (message.picURL !== '') writer.tag(10, WireType.LengthDelimited).string(message.picURL);
    ...
    /* bool isSystem = 15; */
    if (message.isSystem !== false) writer.tag(15, WireType.Varint).bool(message.isSystem);
    ...
    for (let k of globalThis.Object.keys(message.specLabels))
      writer
        ...
        .string(k)
        .tag(2, WireType.LengthDelimited)
        .string(message.specLabels[k])
        .join();
    /* bool isUserHidden = 17; */
    if (message.isUserHidden !== false) writer.tag(17, WireType.Varint).bool(message.isUserHidden);
...
class ObjectReference$Type extends MessageType<ObjectReference> {
  ...
  internalBinaryWrite(
    ...
    /* string uid = 3; */
    if (message.uid !== '') writer.tag(3, WireType.LengthDelimited).string(message.uid);
    /* string name = 4; */
...
class Duration$Type extends MessageType<Duration> {
  ...
  internalBinaryWrite(
    ...
    /* uint32 days = 5; */
    if (message.type.oneofKind === 'days') writer.tag(5, WireType.Varint).uint32(message.type.days);
    /* uint32 weeks = 6; */
...
class DeleteOptions$Type extends MessageType<DeleteOptions> {
  ...
  create(value?: PartialMessage<DeleteOptions>): DeleteOptions {
    ...
    message.uid = '';
    message.name = '';
    if (value !== undefined) reflectionMergePartial<DeleteOptions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetOptions$Type extends MessageType<GetOptions> {
  ...
  create(value?: PartialMessage<GetOptions>): GetOptions {
    ...
    message.uid = '';
    message.name = '';
    if (value !== undefined) reflectionMergePartial<GetOptions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DualStackIP$Type extends MessageType<DualStackIP> {
  ...
  create(value?: PartialMessage<DualStackIP>): DualStackIP {
    ...
    message.ipv4 = '';
    message.ipv6 = '';
    if (value !== undefined) reflectionMergePartial<DualStackIP>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* string ipv4 = 1; */
    if (message.ipv4 !== '') writer.tag(1, WireType.LengthDelimited).string(message.ipv4);
    /* string ipv6 = 2; */
    if (message.ipv6 !== '') writer.tag(2, WireType.LengthDelimited).string(message.ipv6);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DualStackNetwork$Type extends MessageType<DualStackNetwork> {
  ...
  create(value?: PartialMessage<DualStackNetwork>): DualStackNetwork {
    ...
    message.v4 = '';
    message.v6 = '';
    if (value !== undefined) reflectionMergePartial<DualStackNetwork>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* string v4 = 1; */
    if (message.v4 !== '') writer.tag(1, WireType.LengthDelimited).string(message.v4);
    /* string v6 = 2; */
    if (message.v6 !== '') writer.tag(2, WireType.LengthDelimited).string(message.v6);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ListResponseMeta$Type extends MessageType<ListResponseMeta> {
  ...
  create(value?: PartialMessage<ListResponseMeta>): ListResponseMeta {
    ...
    if (value !== undefined) reflectionMergePartial<ListResponseMeta>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* uint32 totalCount = 3; */
    if (message.totalCount !== 0) writer.tag(3, WireType.Varint).uint32(message.totalCount);
    /* bool hasMore = 4; */
    if (message.hasMore !== false) writer.tag(4, WireType.Varint).bool(message.hasMore);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class LogMetadata$Type extends MessageType<LogMetadata> {
  ...
  create(value?: PartialMessage<LogMetadata>): LogMetadata {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.id = '';
    if (value !== undefined) reflectionMergePartial<LogMetadata>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.meta.v1.ObjectReference targetRef */ 4:
          message.targetRef = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.targetRef
...
class CommonListOptions$Type extends MessageType<CommonListOptions> {
  ...
  create(value?: PartialMessage<CommonListOptions>): CommonListOptions {
    ...
    message.page = 0;
    message.itemsPerPage = 0;
    if (value !== undefined) reflectionMergePartial<CommonListOptions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.meta.v1.CommonListOptions.OrderBy orderBy */ 3:
          message.orderBy = CommonListOptions_OrderBy.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.orderBy
  ...
  internalBinaryWrite(
    ...
    if (message.orderBy)
      CommonListOptions_OrderBy.internalBinaryWrite(
        message.orderBy,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class CommonListOptions_OrderBy$Type extends MessageType<CommonListOptions_OrderBy> {
    ...
    super('octelium.api.main.meta.v1.CommonListOptions.OrderBy', [
      {
        ...
        kind: 'enum',
        T: () => [
          'octelium.api.main.meta.v1.CommonListOptions.OrderBy.Type',
      ...
      },
      {
        ...
        kind: 'enum',
        T: () => [
          'octelium.api.main.meta.v1.CommonListOptions.OrderBy.Mode',
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CommonListOptions_OrderBy
  ...
  internalBinaryWrite(
    message: CommonListOptions_OrderBy,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
