...
export interface IMainServiceClient {
  ...
  authenticateWithAuthenticationToken(
    input: AuthenticateWithAuthenticationTokenRequest,
    options?: RpcOptions
  ): UnaryCall<AuthenticateWithAuthenticationTokenRequest, SessionToken>;
  /**
  ...
  authenticateWithAssertion(
    input: AuthenticateWithAssertionRequest,
    options?: RpcOptions
  ): UnaryCall<AuthenticateWithAssertionRequest, SessionToken>;
  /**
  ...
  authenticateWithRefreshToken(
    input: AuthenticateWithRefreshTokenRequest,
    options?: RpcOptions
  ): UnaryCall<AuthenticateWithRefreshTokenRequest, SessionToken>;
  /**
  ...
  authenticateWithAuthenticator(
    input: AuthenticateWithAuthenticatorRequest,
    options?: RpcOptions
  ): UnaryCall<AuthenticateWithAuthenticatorRequest, SessionToken>;
  /**
   ...
   */
  registerDeviceBegin(
    input: RegisterDeviceBeginRequest,
    options?: RpcOptions
  ): UnaryCall<RegisterDeviceBeginRequest, RegisterDeviceBeginResponse>;
  /**
  ...
  registerDeviceFinish(
    input: RegisterDeviceFinishRequest,
    options?: RpcOptions
  ): UnaryCall<RegisterDeviceFinishRequest, RegisterDeviceFinishResponse>;
  /**
   ...
   */
  createAuthenticator(
    input: CreateAuthenticatorRequest,
    options?: RpcOptions
  ): UnaryCall<CreateAuthenticatorRequest, Authenticator>;
  /**
  ...
  updateAuthenticator(
    input: Authenticator,
    options?: RpcOptions
  ): UnaryCall<Authenticator, Authenticator>;
  /**
   ...
   */
  listAuthenticator(
    input: ListAuthenticatorOptions,
    options?: RpcOptions
  ): UnaryCall<ListAuthenticatorOptions, AuthenticatorList>;
  /**
  ...
  deleteAuthenticator(
    input: DeleteOptions,
    options?: RpcOptions
  ): UnaryCall<DeleteOptions, OperationResult>;
  /**
  ...
  registerAuthenticatorBegin(
    input: RegisterAuthenticatorBeginRequest,
    options?: RpcOptions
  ): UnaryCall<RegisterAuthenticatorBeginRequest, RegisterAuthenticatorBeginResponse>;
  /**
  ...
  registerAuthenticatorFinish(
    input: RegisterAuthenticatorFinishRequest,
    options?: RpcOptions
  ): UnaryCall<RegisterAuthenticatorFinishRequest, RegisterAuthenticatorFinishResponse>;
  /**
  ...
  authenticateAuthenticatorBegin(
    input: AuthenticateAuthenticatorBeginRequest,
    options?: RpcOptions
  ): UnaryCall<AuthenticateAuthenticatorBeginRequest, AuthenticateAuthenticatorBeginResponse>;
}
/**
 * @generated from protobuf service octelium.api.main.auth.v1.MainService
 */
export class MainServiceClient implements IMainServiceClient, ServiceInfo {
  ...
  authenticateWithAuthenticationToken(
    ...
    return stackIntercept<AuthenticateWithAuthenticationTokenRequest, SessionToken>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  authenticateWithAssertion(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<AuthenticateWithAssertionRequest, SessionToken>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  authenticateWithRefreshToken(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<AuthenticateWithRefreshTokenRequest, SessionToken>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  authenticateWithAuthenticator(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<AuthenticateWithAuthenticatorRequest, SessionToken>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  registerDeviceBegin(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<RegisterDeviceBeginRequest, RegisterDeviceBeginResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  registerDeviceFinish(
    ...
    const method = this.methods[6],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<RegisterDeviceFinishRequest, RegisterDeviceFinishResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  createAuthenticator(
    ...
    const method = this.methods[8],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<CreateAuthenticatorRequest, Authenticator>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  updateAuthenticator(
    ...
    const method = this.methods[9],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<Authenticator, Authenticator>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  listAuthenticator(
    ...
    const method = this.methods[10],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<ListAuthenticatorOptions, AuthenticatorList>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  deleteAuthenticator(
    ...
    const method = this.methods[11],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DeleteOptions, OperationResult>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  registerAuthenticatorBegin(
    ...
    const method = this.methods[12],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<RegisterAuthenticatorBeginRequest, RegisterAuthenticatorBeginResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  registerAuthenticatorFinish(
    ...
    const method = this.methods[13],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<RegisterAuthenticatorFinishRequest, RegisterAuthenticatorFinishResponse>(
      'unary',
      this._transport,
      method,
      opt,
