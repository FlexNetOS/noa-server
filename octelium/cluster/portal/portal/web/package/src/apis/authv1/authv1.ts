...
class SessionToken$Type extends MessageType<SessionToken> {
  ...
  create(value?: PartialMessage<SessionToken>): SessionToken {
    ...
    if (value !== undefined) reflectionMergePartial<SessionToken>(this, message, value);
    return message;
  }
  internalBinaryRead(
  ...
  internalBinaryWrite(
    ...
    /* int64 expiresIn = 3; */
    if (message.expiresIn !== 0) writer.tag(3, WireType.Varint).int64(message.expiresIn);
...
class ClientLoginRequest$Type extends MessageType<ClientLoginRequest> {
    ...
    super('octelium.api.main.auth.v1.ClientLoginRequest', [
      {
        ...
        kind: 'enum',
        T: () => [
          'octelium.api.main.auth.v1.ClientLoginRequest.APIVersion',
          ClientLoginRequest_APIVersion,
        ],
      },
  ...
  create(value?: PartialMessage<ClientLoginRequest>): ClientLoginRequest {
    ...
    if (value !== undefined) reflectionMergePartial<ClientLoginRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.apiVersion !== 0) writer.tag(1, WireType.Varint).int32(message.apiVersion);
    /* uint32 callbackPort = 2; */
    if (message.callbackPort !== 0) writer.tag(2, WireType.Varint).uint32(message.callbackPort);
...
class ClientLoginResponse$Type extends MessageType<ClientLoginResponse> {
  ...
  create(value?: PartialMessage<ClientLoginResponse>): ClientLoginResponse {
    ...
    if (value !== undefined) reflectionMergePartial<ClientLoginResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class RegisterDeviceBeginRequest$Type extends MessageType<RegisterDeviceBeginRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceBeginRequest
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.RegisterDeviceBeginRequest.Info info */ 1:
          message.info = RegisterDeviceBeginRequest_Info.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.info
  ...
  internalBinaryWrite(
    ...
    if (message.info)
      RegisterDeviceBeginRequest_Info.internalBinaryWrite(
        message.info,
...
class RegisterDeviceBeginRequest_Info$Type extends MessageType<RegisterDeviceBeginRequest_Info> {
    ...
    super('octelium.api.main.auth.v1.RegisterDeviceBeginRequest.Info', [
      {
        ...
        kind: 'enum',
        T: () => [
          'octelium.api.main.auth.v1.RegisterDeviceBeginRequest.Info.OSType',
          RegisterDeviceBeginRequest_Info_OSType,
        ],
      },
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceBeginRequest_Info
  ): RegisterDeviceBeginRequest_Info {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: RegisterDeviceBeginRequest_Info,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.auth.v1.RegisterDeviceBeginRequest.Info.OSType osType = 1; */
    if (message.osType !== 0) writer.tag(1, WireType.Varint).int32(message.osType);
    /* string hostname = 2; */
    if (message.hostname !== '') writer.tag(2, WireType.LengthDelimited).string(message.hostname);
    /* string id = 3; */
    if (message.id !== '') writer.tag(3, WireType.LengthDelimited).string(message.id);
...
class RegisterDeviceBeginResponse$Type extends MessageType<RegisterDeviceBeginResponse> {
  constructor() {
    super('octelium.api.main.auth.v1.RegisterDeviceBeginResponse', [
      { no: 1, name: 'uid', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'message',
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: () => RegisterDeviceBeginResponse_Request,
      },
    ]);
  }
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceBeginResponse
      ...
      switch (fieldNo) {
        ...
        case /* repeated octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request requests */ 2:
          message.requests.push(
            RegisterDeviceBeginResponse_Request.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    /* string uid = 1; */
    if (message.uid !== '') writer.tag(1, WireType.LengthDelimited).string(message.uid);
    /* repeated octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request requests = 2; */
    for (let i = 0; i < message.requests.length; i++)
      RegisterDeviceBeginResponse_Request.internalBinaryWrite(
        message.requests[i],
...
class RegisterDeviceBeginResponse_Request$Type extends MessageType<RegisterDeviceBeginResponse_Request> {
  constructor() {
    super('octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request', [
      { no: 1, name: 'uid', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => RegisterDeviceBeginResponse_Request_Command,
      },
      {
        no: 3,
        name: 'file',
        kind: 'message',
        oneof: 'type',
        T: () => RegisterDeviceBeginResponse_Request_File,
      },
    ]);
  }
  create(
    value?: PartialMessage<RegisterDeviceBeginResponse_Request>
  ): RegisterDeviceBeginResponse_Request {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.uid = '';
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceBeginResponse_Request
  ): RegisterDeviceBeginResponse_Request {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request.Command command */ 2:
          message.type = {
            oneofKind: 'command',
            command: RegisterDeviceBeginResponse_Request_Command.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).command
            ),
          };
          break;
        case /* octelium.api.main.auth.v1.RegisterDeviceBeginResponse.Request.File file */ 3:
          message.type = {
            oneofKind: 'file',
            file: RegisterDeviceBeginResponse_Request_File.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
  ...
  internalBinaryWrite(
    message: RegisterDeviceBeginResponse_Request,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string uid = 1; */
    ...
    if (message.type.oneofKind === 'command')
      RegisterDeviceBeginResponse_Request_Command.internalBinaryWrite(
    ...
    if (message.type.oneofKind === 'file')
      RegisterDeviceBeginResponse_Request_File.internalBinaryWrite(
        message.type.file,
...
class RegisterDeviceBeginResponse_Request_Command$Type extends MessageType<RegisterDeviceBeginResponse_Request_Command> {
  ...
  create(
    value?: PartialMessage<RegisterDeviceBeginResponse_Request_Command>
  ): RegisterDeviceBeginResponse_Request_Command {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.command = '';
    message.args = [];
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceBeginResponse_Request_Command
  ): RegisterDeviceBeginResponse_Request_Command {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterDeviceBeginResponse_Request_Command,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string command = 1; */
 ...
 */
export const RegisterDeviceBeginResponse_Request_Command =
  new RegisterDeviceBeginResponse_Request_Command$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterDeviceBeginResponse_Request_File$Type extends MessageType<RegisterDeviceBeginResponse_Request_File> {
  ...
  create(
    value?: PartialMessage<RegisterDeviceBeginResponse_Request_File>
  ): RegisterDeviceBeginResponse_Request_File {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.path = '';
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceBeginResponse_Request_File
  ): RegisterDeviceBeginResponse_Request_File {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterDeviceBeginResponse_Request_File,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string path = 1; */
 ...
 */
export const RegisterDeviceBeginResponse_Request_File =
  new RegisterDeviceBeginResponse_Request_File$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterDeviceFinishRequest$Type extends MessageType<RegisterDeviceFinishRequest> {
  constructor() {
    super('octelium.api.main.auth.v1.RegisterDeviceFinishRequest', [
      { no: 1, name: 'uid', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'message',
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: () => RegisterDeviceFinishRequest_Response,
      },
    ]);
  }
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceFinishRequest
      ...
      switch (fieldNo) {
        ...
        case /* repeated octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response responses */ 2:
          message.responses.push(
            RegisterDeviceFinishRequest_Response.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.responses.length; i++)
      RegisterDeviceFinishRequest_Response.internalBinaryWrite(
        message.responses[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class RegisterDeviceFinishRequest_Response$Type extends MessageType<RegisterDeviceFinishRequest_Response> {
  constructor() {
    super('octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response', [
      { no: 1, name: 'uid', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => RegisterDeviceFinishRequest_Response_Command,
      },
      {
        no: 3,
        name: 'file',
        kind: 'message',
        oneof: 'type',
        T: () => RegisterDeviceFinishRequest_Response_File,
      },
    ]);
  }
  create(
    value?: PartialMessage<RegisterDeviceFinishRequest_Response>
  ): RegisterDeviceFinishRequest_Response {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.uid = '';
    message.type = { oneofKind: undefined };
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceFinishRequest_Response
  ): RegisterDeviceFinishRequest_Response {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response.Command command */ 2:
          message.type = {
            oneofKind: 'command',
            command: RegisterDeviceFinishRequest_Response_Command.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).command
        ...
        case /* octelium.api.main.auth.v1.RegisterDeviceFinishRequest.Response.File file */ 3:
          message.type = {
            oneofKind: 'file',
            file: RegisterDeviceFinishRequest_Response_File.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).file
  ...
  internalBinaryWrite(
    message: RegisterDeviceFinishRequest_Response,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string uid = 1; */
    ...
    if (message.type.oneofKind === 'command')
      RegisterDeviceFinishRequest_Response_Command.internalBinaryWrite(
        message.type.command,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'file')
      RegisterDeviceFinishRequest_Response_File.internalBinaryWrite(
        message.type.file,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class RegisterDeviceFinishRequest_Response_Command$Type extends MessageType<RegisterDeviceFinishRequest_Response_Command> {
  ...
  create(
    value?: PartialMessage<RegisterDeviceFinishRequest_Response_Command>
  ): RegisterDeviceFinishRequest_Response_Command {
    const message = globalThis.Object.create(this.messagePrototype!);
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceFinishRequest_Response_Command
  ): RegisterDeviceFinishRequest_Response_Command {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterDeviceFinishRequest_Response_Command,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes output = 1; */
    if (message.output.length) writer.tag(1, WireType.LengthDelimited).bytes(message.output);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
export const RegisterDeviceFinishRequest_Response_Command =
  new RegisterDeviceFinishRequest_Response_Command$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterDeviceFinishRequest_Response_File$Type extends MessageType<RegisterDeviceFinishRequest_Response_File> {
  ...
  create(
    value?: PartialMessage<RegisterDeviceFinishRequest_Response_File>
  ): RegisterDeviceFinishRequest_Response_File {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.output = new Uint8Array(0);
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceFinishRequest_Response_File
  ): RegisterDeviceFinishRequest_Response_File {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterDeviceFinishRequest_Response_File,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes output = 1; */
 ...
 */
export const RegisterDeviceFinishRequest_Response_File =
  new RegisterDeviceFinishRequest_Response_File$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterDeviceFinishResponse$Type extends MessageType<RegisterDeviceFinishResponse> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterDeviceFinishResponse
...
class AuthenticateWithAuthenticationTokenRequest$Type extends MessageType<AuthenticateWithAuthenticationTokenRequest> {
  ...
  create(
    value?: PartialMessage<AuthenticateWithAuthenticationTokenRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateWithAuthenticationTokenRequest
  ): AuthenticateWithAuthenticationTokenRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
 ...
 */
export const AuthenticateWithAuthenticationTokenRequest =
  new AuthenticateWithAuthenticationTokenRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateWithAssertionRequest$Type extends MessageType<AuthenticateWithAssertionRequest> {
  ...
  create(
    value?: PartialMessage<AuthenticateWithAssertionRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateWithAssertionRequest
  ): AuthenticateWithAssertionRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.meta.v1.ObjectReference identityProviderRef */ 1:
          message.identityProviderRef = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.identityProviderRef
          );
          break;
  ...
  internalBinaryWrite(
    ...
    /* string assertion = 2; */
    if (message.assertion !== '') writer.tag(2, WireType.LengthDelimited).string(message.assertion);
...
class AuthenticateWithRefreshTokenRequest$Type extends MessageType<AuthenticateWithRefreshTokenRequest> {
  ...
  create(
    value?: PartialMessage<AuthenticateWithRefreshTokenRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateWithRefreshTokenRequest
  ): AuthenticateWithRefreshTokenRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class TokenT0$Type extends MessageType<TokenT0> {
  ...
  create(value?: PartialMessage<TokenT0>): TokenT0 {
    ...
    if (value !== undefined) reflectionMergePartial<TokenT0>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.TokenT0.Content content */ 2:
          message.content = TokenT0_Content.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.content
  ...
  internalBinaryWrite(
    ...
    /* bytes signature = 1; */
    if (message.signature.length) writer.tag(1, WireType.LengthDelimited).bytes(message.signature);
    /* octelium.api.main.auth.v1.TokenT0.Content content = 2; */
    if (message.content)
      TokenT0_Content.internalBinaryWrite(
        message.content,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class TokenT0_Content$Type extends MessageType<TokenT0_Content> {
    ...
    super('octelium.api.main.auth.v1.TokenT0.Content', [
      {
        ...
        name: 'type',
        kind: 'enum',
        T: () => ['octelium.api.main.auth.v1.TokenT0.Content.Type', TokenT0_Content_Type],
      },
  ...
  create(value?: PartialMessage<TokenT0_Content>): TokenT0_Content {
    ...
    if (value !== undefined) reflectionMergePartial<TokenT0_Content>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* bytes keyID = 2; */
    if (message.keyID.length) writer.tag(2, WireType.LengthDelimited).bytes(message.keyID);
    /* bytes subject = 3; */
    if (message.subject.length) writer.tag(3, WireType.LengthDelimited).bytes(message.subject);
    /* bytes tokenID = 4; */
    if (message.tokenID.length) writer.tag(4, WireType.LengthDelimited).bytes(message.tokenID);
...
class AuthenticateAuthenticatorBeginRequest$Type extends MessageType<AuthenticateAuthenticatorBeginRequest> {
  ...
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginRequest
  ): AuthenticateAuthenticatorBeginRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.meta.v1.ObjectReference authenticatorRef */ 1:
          message.authenticatorRef = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
 ...
 */
export const AuthenticateAuthenticatorBeginRequest =
  new AuthenticateAuthenticatorBeginRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateAuthenticatorBeginResponse$Type extends MessageType<AuthenticateAuthenticatorBeginResponse> {
    ...
    super('octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse', [
      {
        ...
        kind: 'message',
        T: () => AuthenticateAuthenticatorBeginResponse_ChallengeRequest,
      },
    ]);
  }
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginResponse
  ): AuthenticateAuthenticatorBeginResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest challengeRequest */ 1:
          message.challengeRequest =
            AuthenticateAuthenticatorBeginResponse_ChallengeRequest.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              message.challengeRequest
  ...
  internalBinaryWrite(
    ...
    if (message.challengeRequest)
      AuthenticateAuthenticatorBeginResponse_ChallengeRequest.internalBinaryWrite(
        message.challengeRequest,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
 ...
 */
export const AuthenticateAuthenticatorBeginResponse =
  new AuthenticateAuthenticatorBeginResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateAuthenticatorBeginResponse_ChallengeRequest$Type extends MessageType<AuthenticateAuthenticatorBeginResponse_ChallengeRequest> {
    ...
    super('octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest', [
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO,
      },
      {
        no: 2,
        name: 'totp',
        kind: 'message',
        oneof: 'type',
        T: () => AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP,
      },
      {
        no: 3,
        name: 'tpm',
        kind: 'message',
        oneof: 'type',
        T: () => AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM,
      },
    ]);
  }
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginResponse_ChallengeRequest>
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.type = { oneofKind: undefined };
    if (value !== undefined)
      reflectionMergePartial<AuthenticateAuthenticatorBeginResponse_ChallengeRequest>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginResponse_ChallengeRequest
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.FIDO fido */ 1:
          message.type = {
            oneofKind: 'fido',
            fido: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).fido
            ),
          };
          break;
        case /* octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.TOTP totp */ 2:
          message.type = {
            oneofKind: 'totp',
            totp: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).totp
            ),
          };
          break;
        case /* octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.TPM tpm */ 3:
          message.type = {
            oneofKind: 'tpm',
            tpm: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).tpm
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    message: AuthenticateAuthenticatorBeginResponse_ChallengeRequest,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    ...
    if (message.type.oneofKind === 'fido')
      AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO.internalBinaryWrite(
        message.type.fido,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'totp')
      AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP.internalBinaryWrite(
        message.type.totp,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'tpm')
      AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM.internalBinaryWrite(
        message.type.tpm,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
 ...
 */
export const AuthenticateAuthenticatorBeginResponse_ChallengeRequest =
  new AuthenticateAuthenticatorBeginResponse_ChallengeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO$Type extends MessageType<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO> {
  ...
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO>
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.request = '';
    if (value !== undefined)
      reflectionMergePartial<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string request = 1; */
    if (message.request !== '') writer.tag(1, WireType.LengthDelimited).string(message.request);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
export const AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO =
  new AuthenticateAuthenticatorBeginResponse_ChallengeRequest_FIDO$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP$Type extends MessageType<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP> {
  ...
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP>
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined)
      reflectionMergePartial<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    let u = options.writeUnknownFields;
 ...
 */
export const AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP =
  new AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TOTP$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM$Type extends MessageType<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM> {
    ...
    super('octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.TPM', [
      {
        ...
        kind: 'message',
        T: () => AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential,
      },
      { no: 2, name: 'akBytes', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
    ]);
  }
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM>
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.akBytes = new Uint8Array(0);
    if (value !== undefined)
      reflectionMergePartial<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.AuthenticateAuthenticatorBeginResponse.ChallengeRequest.TPM.EncryptedCredential encryptedCredential */ 1:
          message.encryptedCredential =
            AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              message.encryptedCredential
  ...
  internalBinaryWrite(
    message: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    ...
    if (message.encryptedCredential)
      AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential.internalBinaryWrite(
        message.encryptedCredential,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* bytes akBytes = 2; */
    if (message.akBytes.length) writer.tag(2, WireType.LengthDelimited).bytes(message.akBytes);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
export const AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM =
  new AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential$Type extends MessageType<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential> {
  ...
  create(
    value?: PartialMessage<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential>
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.credential = new Uint8Array(0);
    message.secret = new Uint8Array(0);
    if (value !== undefined)
      reflectionMergePartial<AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential
  ): AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes credential = 1; */
    ...
    /* bytes secret = 2; */
    if (message.secret.length) writer.tag(2, WireType.LengthDelimited).bytes(message.secret);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
export const AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential =
  new AuthenticateAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginRequest$Type extends MessageType<RegisterAuthenticatorBeginRequest> {
  constructor() {
    super('octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest', [
      { no: 1, name: 'authenticatorRef', kind: 'message', T: () => ObjectReference },
      {
        ...
        name: 'preChallenge',
        kind: 'message',
        T: () => RegisterAuthenticatorBeginRequest_PreChallenge,
      },
    ]);
  }
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginRequest
  ): RegisterAuthenticatorBeginRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge preChallenge */ 2:
          message.preChallenge = RegisterAuthenticatorBeginRequest_PreChallenge.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.preChallenge)
      RegisterAuthenticatorBeginRequest_PreChallenge.internalBinaryWrite(
        message.preChallenge,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class RegisterAuthenticatorBeginRequest_PreChallenge$Type extends MessageType<RegisterAuthenticatorBeginRequest_PreChallenge> {
    ...
    super('octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge', [
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => RegisterAuthenticatorBeginRequest_PreChallenge_TPM,
      },
    ]);
  }
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginRequest_PreChallenge>
  ): RegisterAuthenticatorBeginRequest_PreChallenge {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.type = { oneofKind: undefined };
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginRequest_PreChallenge
  ): RegisterAuthenticatorBeginRequest_PreChallenge {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge.TPM tpm */ 1:
          message.type = {
            oneofKind: 'tpm',
            tpm: RegisterAuthenticatorBeginRequest_PreChallenge_TPM.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).tpm
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginRequest_PreChallenge,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge.TPM tpm = 1; */
    if (message.type.oneofKind === 'tpm')
      RegisterAuthenticatorBeginRequest_PreChallenge_TPM.internalBinaryWrite(
        message.type.tpm,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
 ...
 */
export const RegisterAuthenticatorBeginRequest_PreChallenge =
  new RegisterAuthenticatorBeginRequest_PreChallenge$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginRequest_PreChallenge_TPM$Type extends MessageType<RegisterAuthenticatorBeginRequest_PreChallenge_TPM> {
  constructor() {
    super('octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge.TPM', [
      { no: 1, name: 'akBytes', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
      {
        ...
        kind: 'message',
        T: () => RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters,
      },
      {
        no: 3,
        name: 'ekCertificateDER',
        kind: 'scalar',
        oneof: 'ekType',
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginRequest_PreChallenge_TPM>
  ): RegisterAuthenticatorBeginRequest_PreChallenge_TPM {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.akBytes = new Uint8Array(0);
    message.ekType = { oneofKind: undefined };
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginRequest_PreChallenge_TPM>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginRequest_PreChallenge_TPM
  ): RegisterAuthenticatorBeginRequest_PreChallenge_TPM {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginRequest.PreChallenge.TPM.AttestationParameters attestationParameters */ 2:
          message.attestationParameters =
            RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              message.attestationParameters
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginRequest_PreChallenge_TPM,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes akBytes = 1; */
    if (message.akBytes.length) writer.tag(1, WireType.LengthDelimited).bytes(message.akBytes);
    ...
    if (message.attestationParameters)
      RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters.internalBinaryWrite(
        message.attestationParameters,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
 ...
 */
export const RegisterAuthenticatorBeginRequest_PreChallenge_TPM =
  new RegisterAuthenticatorBeginRequest_PreChallenge_TPM$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters$Type extends MessageType<RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters> {
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters>
  ): RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters {
    const message = globalThis.Object.create(this.messagePrototype!);
    ...
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters
  ): RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes public = 1; */
    if (message.public.length) writer.tag(1, WireType.LengthDelimited).bytes(message.public);
    /* bytes createData = 2; */
 ...
 */
export const RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters =
  new RegisterAuthenticatorBeginRequest_PreChallenge_TPM_AttestationParameters$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginResponse$Type extends MessageType<RegisterAuthenticatorBeginResponse> {
    ...
    super('octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse', [
      {
        ...
        name: 'challengeRequest',
        kind: 'message',
        T: () => RegisterAuthenticatorBeginResponse_ChallengeRequest,
      },
    ]);
  }
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginResponse
  ): RegisterAuthenticatorBeginResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest challengeRequest */ 1:
          message.challengeRequest =
            RegisterAuthenticatorBeginResponse_ChallengeRequest.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              message.challengeRequest
  ...
  internalBinaryWrite(
    ...
    if (message.challengeRequest)
      RegisterAuthenticatorBeginResponse_ChallengeRequest.internalBinaryWrite(
        message.challengeRequest,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class RegisterAuthenticatorBeginResponse_ChallengeRequest$Type extends MessageType<RegisterAuthenticatorBeginResponse_ChallengeRequest> {
    ...
    super('octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest', [
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO,
      },
      {
        no: 2,
        name: 'totp',
        kind: 'message',
        oneof: 'type',
        T: () => RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP,
      },
      {
        no: 3,
        name: 'tpm',
        kind: 'message',
        oneof: 'type',
        T: () => RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM,
      },
    ]);
  }
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginResponse_ChallengeRequest>
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.type = { oneofKind: undefined };
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginResponse_ChallengeRequest>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginResponse_ChallengeRequest
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.FIDO fido */ 1:
          message.type = {
            oneofKind: 'fido',
            fido: RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).fido
        ...
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.TOTP totp */ 2:
          message.type = {
            oneofKind: 'totp',
            totp: RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).totp
        ...
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.TPM tpm */ 3:
          message.type = {
            oneofKind: 'tpm',
            tpm: RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).tpm
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginResponse_ChallengeRequest,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.FIDO fido = 1; */
    if (message.type.oneofKind === 'fido')
      RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO.internalBinaryWrite(
        message.type.fido,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'totp')
      RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP.internalBinaryWrite(
        message.type.totp,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'tpm')
      RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM.internalBinaryWrite(
        message.type.tpm,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
 ...
 */
export const RegisterAuthenticatorBeginResponse_ChallengeRequest =
  new RegisterAuthenticatorBeginResponse_ChallengeRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO$Type extends MessageType<RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO> {
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO>
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.request = '';
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string request = 1; */
 ...
 */
export const RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO =
  new RegisterAuthenticatorBeginResponse_ChallengeRequest_FIDO$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP$Type extends MessageType<RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP> {
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP>
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.url = '';
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string url = 1; */
 ...
 */
export const RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP =
  new RegisterAuthenticatorBeginResponse_ChallengeRequest_TOTP$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM$Type extends MessageType<RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM> {
    ...
    super('octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.TPM', [
      {
        ...
        name: 'encryptedCredential',
        kind: 'message',
        T: () => RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential,
      },
      { no: 2, name: 'akBytes', kind: 'scalar', T: 12 /*ScalarType.BYTES*/ },
    ]);
  }
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM>
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.akBytes = new Uint8Array(0);
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.RegisterAuthenticatorBeginResponse.ChallengeRequest.TPM.EncryptedCredential encryptedCredential */ 1:
          message.encryptedCredential =
            RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              message.encryptedCredential
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    ...
    if (message.encryptedCredential)
      RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential.internalBinaryWrite(
        message.encryptedCredential,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
 ...
 */
export const RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM =
  new RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential$Type extends MessageType<RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential> {
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential>
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.credential = new Uint8Array(0);
    message.secret = new Uint8Array(0);
    if (value !== undefined)
      reflectionMergePartial<RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential
  ): RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes credential = 1; */
 ...
 */
export const RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential =
  new RegisterAuthenticatorBeginResponse_ChallengeRequest_TPM_EncryptedCredential$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Authenticator$Type extends MessageType<Authenticator> {
  ...
  create(value?: PartialMessage<Authenticator>): Authenticator {
    ...
    message.apiVersion = '';
    message.kind = '';
    if (value !== undefined) reflectionMergePartial<Authenticator>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.Authenticator.Spec spec */ 4:
          message.spec = Authenticator_Spec.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.spec
        ...
        case /* octelium.api.main.auth.v1.Authenticator.Status status */ 5:
          message.status = Authenticator_Status.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status
  ...
  internalBinaryWrite(
    ...
    /* string kind = 2; */
    if (message.kind !== '') writer.tag(2, WireType.LengthDelimited).string(message.kind);
    ...
    if (message.spec)
      Authenticator_Spec.internalBinaryWrite(
        message.spec,
    ...
    if (message.status)
      Authenticator_Status.internalBinaryWrite(
        message.status,
        writer.tag(5, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class Authenticator_Spec$Type extends MessageType<Authenticator_Spec> {
  ...
  create(value?: PartialMessage<Authenticator_Spec>): Authenticator_Spec {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.displayName = '';
    if (value !== undefined) reflectionMergePartial<Authenticator_Spec>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Authenticator_Status$Type extends MessageType<Authenticator_Status> {
  constructor() {
    super('octelium.api.main.auth.v1.Authenticator.Status', [
      { no: 1, name: 'isRegistered', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
      {
        ...
        name: 'type',
        kind: 'enum',
        T: () => ['octelium.api.main.auth.v1.Authenticator.Status.Type', Authenticator_Status_Type],
      },
    ]);
  }
  create(value?: PartialMessage<Authenticator_Status>): Authenticator_Status {
    ...
    message.type = 0;
    if (value !== undefined) reflectionMergePartial<Authenticator_Status>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    message: Authenticator_Status,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bool isRegistered = 1; */
    if (message.isRegistered !== false) writer.tag(1, WireType.Varint).bool(message.isRegistered);
...
class AuthenticatorList$Type extends MessageType<AuthenticatorList> {
  ...
  create(value?: PartialMessage<AuthenticatorList>): AuthenticatorList {
    ...
    message.kind = '';
    message.items = [];
    if (value !== undefined) reflectionMergePartial<AuthenticatorList>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.meta.v1.ListResponseMeta listResponseMeta */ 4:
          message.listResponseMeta = ListResponseMeta.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.items.length; i++)
      Authenticator.internalBinaryWrite(
        message.items[i],
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.listResponseMeta)
      ListResponseMeta.internalBinaryWrite(
        message.listResponseMeta,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class ListAuthenticatorOptions$Type extends MessageType<ListAuthenticatorOptions> {
  ...
  create(value?: PartialMessage<ListAuthenticatorOptions>): ListAuthenticatorOptions {
    ...
    if (value !== undefined) reflectionMergePartial<ListAuthenticatorOptions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: ListAuthenticatorOptions
  ...
  internalBinaryWrite(
    ...
    /* uint32 page = 1; */
    if (message.page !== 0) writer.tag(1, WireType.Varint).uint32(message.page);
    /* uint32 itemsPerPage = 2; */
    if (message.itemsPerPage !== 0) writer.tag(2, WireType.Varint).uint32(message.itemsPerPage);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CreateAuthenticatorRequest$Type extends MessageType<CreateAuthenticatorRequest> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: CreateAuthenticatorRequest
...
class RegisterAuthenticatorFinishRequest$Type extends MessageType<RegisterAuthenticatorFinishRequest> {
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorFinishRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorFinishRequest
  ): RegisterAuthenticatorFinishRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.auth.v1.ChallengeResponse challengeResponse */ 2:
          message.challengeResponse = ChallengeResponse.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.challengeResponse)
      ChallengeResponse.internalBinaryWrite(
        message.challengeResponse,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class RegisterAuthenticatorFinishResponse$Type extends MessageType<RegisterAuthenticatorFinishResponse> {
  ...
  create(
    value?: PartialMessage<RegisterAuthenticatorFinishResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: RegisterAuthenticatorFinishResponse
  ): RegisterAuthenticatorFinishResponse {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
class ChallengeResponse$Type extends MessageType<ChallengeResponse> {
  ...
  create(value?: PartialMessage<ChallengeResponse>): ChallengeResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.type = { oneofKind: undefined };
    if (value !== undefined) reflectionMergePartial<ChallengeResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.auth.v1.ChallengeResponse.FIDO fido */ 1:
          message.type = {
            oneofKind: 'fido',
            fido: ChallengeResponse_FIDO.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).fido
        ...
        case /* octelium.api.main.auth.v1.ChallengeResponse.TOTP totp */ 2:
          message.type = {
            oneofKind: 'totp',
            totp: ChallengeResponse_TOTP.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).totp
        ...
        case /* octelium.api.main.auth.v1.ChallengeResponse.TPM tpm */ 3:
          message.type = {
            oneofKind: 'tpm',
            tpm: ChallengeResponse_TPM.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).tpm
  ...
  internalBinaryWrite(
    ...
    if (message.type.oneofKind === 'fido')
      ChallengeResponse_FIDO.internalBinaryWrite(
        message.type.fido,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'totp')
      ChallengeResponse_TOTP.internalBinaryWrite(
        message.type.totp,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.type.oneofKind === 'tpm')
      ChallengeResponse_TPM.internalBinaryWrite(
        message.type.tpm,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class ChallengeResponse_FIDO$Type extends MessageType<ChallengeResponse_FIDO> {
  ...
  create(value?: PartialMessage<ChallengeResponse_FIDO>): ChallengeResponse_FIDO {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.response = '';
    if (value !== undefined) reflectionMergePartial<ChallengeResponse_FIDO>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    message: ChallengeResponse_FIDO,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string response = 1; */
...
class ChallengeResponse_TOTP$Type extends MessageType<ChallengeResponse_TOTP> {
  ...
  create(value?: PartialMessage<ChallengeResponse_TOTP>): ChallengeResponse_TOTP {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.response = '';
    if (value !== undefined) reflectionMergePartial<ChallengeResponse_TOTP>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    message: ChallengeResponse_TOTP,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string response = 1; */
...
class ChallengeResponse_TPM$Type extends MessageType<ChallengeResponse_TPM> {
  ...
  create(value?: PartialMessage<ChallengeResponse_TPM>): ChallengeResponse_TPM {
    ...
    if (value !== undefined) reflectionMergePartial<ChallengeResponse_TPM>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    message: ChallengeResponse_TPM,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes response = 1; */
    if (message.response.length) writer.tag(1, WireType.LengthDelimited).bytes(message.response);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class AuthenticateWithAuthenticatorRequest$Type extends MessageType<AuthenticateWithAuthenticatorRequest> {
  ...
  create(
    value?: PartialMessage<AuthenticateWithAuthenticatorRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AuthenticateWithAuthenticatorRequest
  ): AuthenticateWithAuthenticatorRequest {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
export const MainService = new ServiceType('octelium.api.main.auth.v1.MainService', [
  {
    name: 'AuthenticateWithAuthenticationToken',
    options: {},
    I: AuthenticateWithAuthenticationTokenRequest,
    O: SessionToken,
  },
  {
    name: 'AuthenticateWithAssertion',
    options: {},
    I: AuthenticateWithAssertionRequest,
    O: SessionToken,
  },
  {
    name: 'AuthenticateWithRefreshToken',
    options: {},
    I: AuthenticateWithRefreshTokenRequest,
    O: SessionToken,
  },
  {
    name: 'AuthenticateWithAuthenticator',
    options: {},
    I: AuthenticateWithAuthenticatorRequest,
    O: SessionToken,
  },
  { name: 'Logout', options: {}, I: LogoutRequest, O: LogoutResponse },
  {
    name: 'RegisterDeviceBegin',
    options: {},
    I: RegisterDeviceBeginRequest,
    O: RegisterDeviceBeginResponse,
  },
  {
    name: 'RegisterDeviceFinish',
    options: {},
    I: RegisterDeviceFinishRequest,
    O: RegisterDeviceFinishResponse,
  },
  ...
  {
    name: 'RegisterAuthenticatorBegin',
    options: {},
    I: RegisterAuthenticatorBeginRequest,
    O: RegisterAuthenticatorBeginResponse,
  },
  {
    name: 'RegisterAuthenticatorFinish',
    options: {},
    I: RegisterAuthenticatorFinishRequest,
    O: RegisterAuthenticatorFinishResponse,
  },
  {
    name: 'AuthenticateAuthenticatorBegin',
    options: {},
    I: AuthenticateAuthenticatorBeginRequest,
    O: AuthenticateAuthenticatorBeginResponse,
  },
]);
