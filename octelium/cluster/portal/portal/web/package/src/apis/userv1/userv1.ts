...
class GetStatusRequest$Type extends MessageType<GetStatusRequest> {
  ...
  create(value?: PartialMessage<GetStatusRequest>): GetStatusRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<GetStatusRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class GetStatusResponse$Type extends MessageType<GetStatusResponse> {
  ...
  create(value?: PartialMessage<GetStatusResponse>): GetStatusResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.domain = '';
    if (value !== undefined) reflectionMergePartial<GetStatusResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.Cluster cluster */ 2:
          message.cluster = GetStatusResponse_Cluster.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.cluster
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.User user */ 3:
          message.user = GetStatusResponse_User.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.user
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.Session session */ 4:
          message.session = GetStatusResponse_Session.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.session
  ...
  internalBinaryWrite(
    ...
    if (message.cluster)
      GetStatusResponse_Cluster.internalBinaryWrite(
        message.cluster,
    ...
    if (message.user)
      GetStatusResponse_User.internalBinaryWrite(
        message.user,
    ...
    if (message.session)
      GetStatusResponse_Session.internalBinaryWrite(
        message.session,
...
class GetStatusResponse_User$Type extends MessageType<GetStatusResponse_User> {
  ...
  create(value?: PartialMessage<GetStatusResponse_User>): GetStatusResponse_User {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<GetStatusResponse_User>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_User
  ): GetStatusResponse_User {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.User.Spec spec */ 2:
          message.spec = GetStatusResponse_User_Spec.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.spec
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.User.Status status */ 3:
          message.status = GetStatusResponse_User_Status.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status
  ...
  internalBinaryWrite(
    message: GetStatusResponse_User,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    ...
    if (message.spec)
      GetStatusResponse_User_Spec.internalBinaryWrite(
        message.spec,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.status)
      GetStatusResponse_User_Status.internalBinaryWrite(
        message.status,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class GetStatusResponse_User_Spec$Type extends MessageType<GetStatusResponse_User_Spec> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_User_Spec
  ): GetStatusResponse_User_Spec {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: GetStatusResponse_User_Spec,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string email = 1; */
...
class GetStatusResponse_User_Status$Type extends MessageType<GetStatusResponse_User_Status> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_User_Status
  ): GetStatusResponse_User_Status {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: GetStatusResponse_User_Status,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    let u = options.writeUnknownFields;
...
class GetStatusResponse_Session$Type extends MessageType<GetStatusResponse_Session> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_Session
  ): GetStatusResponse_Session {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.Session.Spec spec */ 2:
          message.spec = GetStatusResponse_Session_Spec.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.spec
        ...
        case /* octelium.api.main.user.v1.GetStatusResponse.Session.Status status */ 3:
          message.status = GetStatusResponse_Session_Status.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status
  ...
  internalBinaryWrite(
    message: GetStatusResponse_Session,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.meta.v1.Metadata metadata = 1; */
    ...
    if (message.spec)
      GetStatusResponse_Session_Spec.internalBinaryWrite(
        message.spec,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.status)
      GetStatusResponse_Session_Status.internalBinaryWrite(
        message.status,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class GetStatusResponse_Session_Spec$Type extends MessageType<GetStatusResponse_Session_Spec> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_Session_Spec
  ): GetStatusResponse_Session_Spec {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: GetStatusResponse_Session_Spec,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    let u = options.writeUnknownFields;
...
class GetStatusResponse_Session_Status$Type extends MessageType<GetStatusResponse_Session_Status> {
    ...
    super('octelium.api.main.user.v1.GetStatusResponse.Session.Status', [
      {
        ...
        kind: 'enum',
        T: () => [
          'octelium.api.main.user.v1.GetStatusResponse.Session.Status.Type',
          GetStatusResponse_Session_Status_Type,
        ],
      },
    ]);
  }
  create(
    value?: PartialMessage<GetStatusResponse_Session_Status>
  ): GetStatusResponse_Session_Status {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.type = 0;
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_Session_Status
  ): GetStatusResponse_Session_Status {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: GetStatusResponse_Session_Status,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
...
class GetStatusResponse_Cluster$Type extends MessageType<GetStatusResponse_Cluster> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: GetStatusResponse_Cluster
  ): GetStatusResponse_Cluster {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: GetStatusResponse_Cluster,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.meta.v1.Metadata metadata = 1; */
...
class ConnectRequest$Type extends MessageType<ConnectRequest> {
  ...
  create(value?: PartialMessage<ConnectRequest>): ConnectRequest {
    ...
    if (value !== undefined) reflectionMergePartial<ConnectRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.user.v1.ConnectRequest.Initialize initialize */ 1:
          message.type = {
            oneofKind: 'initialize',
            initialize: ConnectRequest_Initialize.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).initialize
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.type.oneofKind === 'initialize')
      ConnectRequest_Initialize.internalBinaryWrite(
...
class ConnectRequest_Initialize$Type extends MessageType<ConnectRequest_Initialize> {
    ...
    super('octelium.api.main.user.v1.ConnectRequest.Initialize', [
      {
        ...
        kind: 'enum',
        T: () => [
          'octelium.api.main.user.v1.ConnectRequest.Initialize.L3Mode',
          ConnectRequest_Initialize_L3Mode,
        ],
      },
      {
        no: 2,
        name: 'serviceOptions',
        kind: 'message',
        T: () => ConnectRequest_Initialize_ServiceOptions,
      },
      {
        no: 3,
        name: 'connectionType',
        kind: 'enum',
        T: () => [
          'octelium.api.main.user.v1.ConnectRequest.Initialize.ConnectionType',
          ConnectRequest_Initialize_ConnectionType,
        ],
      },
      {
        no: 4,
        ...
        T: () => ConnectRequest_Initialize_PublishedService,
      },
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectRequest_Initialize
  ): ConnectRequest_Initialize {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.ConnectRequest.Initialize.ServiceOptions serviceOptions */ 2:
          message.serviceOptions = ConnectRequest_Initialize_ServiceOptions.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* repeated octelium.api.main.user.v1.ConnectRequest.Initialize.PublishedService publishedServices */ 4:
          message.publishedServices.push(
            ConnectRequest_Initialize_PublishedService.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.publishedServices.length; i++)
      ConnectRequest_Initialize_PublishedService.internalBinaryWrite(
        message.publishedServices[i],
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* bool ignoreDNS = 5; */
    if (message.ignoreDNS !== false) writer.tag(5, WireType.Varint).bool(message.ignoreDNS);
    /* bool eSSHEnable = 6; */
    if (message.eSSHEnable !== false) writer.tag(6, WireType.Varint).bool(message.eSSHEnable);
    /* int32 eSSHPort = 7; */
    if (message.eSSHPort !== 0) writer.tag(7, WireType.Varint).int32(message.eSSHPort);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ConnectRequest_Initialize_ServiceOptions$Type extends MessageType<ConnectRequest_Initialize_ServiceOptions> {
  constructor() {
    super('octelium.api.main.user.v1.ConnectRequest.Initialize.ServiceOptions', [
      { no: 1, name: 'serveAll', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
      {
        ...
        kind: 'message',
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: () => ConnectRequest_Initialize_ServiceOptions_Service,
      },
  ...
  create(
    value?: PartialMessage<ConnectRequest_Initialize_ServiceOptions>
  ): ConnectRequest_Initialize_ServiceOptions {
    const message = globalThis.Object.create(this.messagePrototype!);
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectRequest_Initialize_ServiceOptions
  ): ConnectRequest_Initialize_ServiceOptions {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated octelium.api.main.user.v1.ConnectRequest.Initialize.ServiceOptions.Service services */ 2:
          message.services.push(
            ConnectRequest_Initialize_ServiceOptions_Service.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    message: ConnectRequest_Initialize_ServiceOptions,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bool serveAll = 1; */
    if (message.serveAll !== false) writer.tag(1, WireType.Varint).bool(message.serveAll);
    ...
    for (let i = 0; i < message.services.length; i++)
      ConnectRequest_Initialize_ServiceOptions_Service.internalBinaryWrite(
        message.services[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    /* int32 portStart = 4; */
    if (message.portStart !== 0) writer.tag(4, WireType.Varint).int32(message.portStart);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
export const ConnectRequest_Initialize_ServiceOptions =
  new ConnectRequest_Initialize_ServiceOptions$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConnectRequest_Initialize_ServiceOptions_Service$Type extends MessageType<ConnectRequest_Initialize_ServiceOptions_Service> {
  ...
  create(
    value?: PartialMessage<ConnectRequest_Initialize_ServiceOptions_Service>
  ): ConnectRequest_Initialize_ServiceOptions_Service {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.name = '';
    if (value !== undefined)
      reflectionMergePartial<ConnectRequest_Initialize_ServiceOptions_Service>(
        this,
        message,
        value
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectRequest_Initialize_ServiceOptions_Service
  ): ConnectRequest_Initialize_ServiceOptions_Service {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: ConnectRequest_Initialize_ServiceOptions_Service,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string name = 1; */
 ...
 */
export const ConnectRequest_Initialize_ServiceOptions_Service =
  new ConnectRequest_Initialize_ServiceOptions_Service$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConnectRequest_Initialize_PublishedService$Type extends MessageType<ConnectRequest_Initialize_PublishedService> {
  ...
  create(
    value?: PartialMessage<ConnectRequest_Initialize_PublishedService>
  ): ConnectRequest_Initialize_PublishedService {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.name = '';
    message.port = 0;
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectRequest_Initialize_PublishedService
  ): ConnectRequest_Initialize_PublishedService {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: ConnectRequest_Initialize_PublishedService,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string name = 1; */
 ...
 */
export const ConnectRequest_Initialize_PublishedService =
  new ConnectRequest_Initialize_PublishedService$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DisconnectRequest$Type extends MessageType<DisconnectRequest> {
  ...
  create(value?: PartialMessage<DisconnectRequest>): DisconnectRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<DisconnectRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DisconnectResponse$Type extends MessageType<DisconnectResponse> {
  ...
  create(value?: PartialMessage<DisconnectResponse>): DisconnectResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<DisconnectResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Gateway$Type extends MessageType<Gateway> {
  ...
  create(value?: PartialMessage<Gateway>): Gateway {
    ...
    message.cIDRs = [];
    message.hostname = '';
    if (value !== undefined) reflectionMergePartial<Gateway>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.Gateway.WireGuard wireguard */ 5:
          message.wireguard = Gateway_WireGuard.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.wireguard
        ...
        case /* octelium.api.main.user.v1.Gateway.QUICV0 quicv0 */ 6:
          message.quicv0 = Gateway_QUICV0.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.quicv0
  ...
  internalBinaryWrite(
    ...
    /* string hostname = 4; */
    if (message.hostname !== '') writer.tag(4, WireType.LengthDelimited).string(message.hostname);
    /* octelium.api.main.user.v1.Gateway.WireGuard wireguard = 5; */
    if (message.wireguard)
      Gateway_WireGuard.internalBinaryWrite(
        message.wireguard,
    ...
    if (message.quicv0)
      Gateway_QUICV0.internalBinaryWrite(
        message.quicv0,
...
class Gateway_WireGuard$Type extends MessageType<Gateway_WireGuard> {
  ...
  create(value?: PartialMessage<Gateway_WireGuard>): Gateway_WireGuard {
    ...
    if (value !== undefined) reflectionMergePartial<Gateway_WireGuard>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Gateway_QUICV0$Type extends MessageType<Gateway_QUICV0> {
  ...
  create(value?: PartialMessage<Gateway_QUICV0>): Gateway_QUICV0 {
    ...
    message.port = 0;
    message.keepAliveSeconds = 0;
    if (value !== undefined) reflectionMergePartial<Gateway_QUICV0>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DNS$Type extends MessageType<DNS> {
  ...
  create(value?: PartialMessage<DNS>): DNS {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.servers = [];
    if (value !== undefined) reflectionMergePartial<DNS>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class HostedService$Type extends MessageType<HostedService> {
  constructor() {
    super('octelium.api.main.user.v1.HostedService', [
      ...
      { no: 2, name: 'port', kind: 'scalar', T: 13 /*ScalarType.UINT32*/ },
      {
        ...
        name: 'l4Type',
        kind: 'enum',
        T: () => ['octelium.api.main.user.v1.HostedService.L4Type', HostedService_L4Type],
      },
      ...
      { no: 5, name: 'address', kind: 'message', T: () => DualStackIP },
      {
        ...
        name: 'mode',
        kind: 'enum',
        T: () => ['octelium.api.main.user.v1.HostedService.Mode', HostedService_Mode, 'MODE_'],
      },
    ]);
  }
  create(value?: PartialMessage<HostedService>): HostedService {
    ...
    message.l4Type = 0;
    message.mode = 0;
    if (value !== undefined) reflectionMergePartial<HostedService>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.HostedService.Upstream upstream */ 4:
          message.upstream = HostedService_Upstream.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.upstream
        ...
        case /* octelium.api.main.meta.v1.DualStackIP address */ 5:
          message.address = DualStackIP.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.address
  ...
  internalBinaryWrite(
    ...
    if (message.l4Type !== 0) writer.tag(3, WireType.Varint).int32(message.l4Type);
    /* octelium.api.main.user.v1.HostedService.Upstream upstream = 4; */
    if (message.upstream)
      HostedService_Upstream.internalBinaryWrite(
        message.upstream,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.address)
      DualStackIP.internalBinaryWrite(
        message.address,
        writer.tag(5, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* octelium.api.main.user.v1.HostedService.Mode mode = 6; */
    if (message.mode !== 0) writer.tag(6, WireType.Varint).int32(message.mode);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class HostedService_Upstream$Type extends MessageType<HostedService_Upstream> {
  ...
  create(value?: PartialMessage<HostedService_Upstream>): HostedService_Upstream {
    ...
    message.host = '';
    message.port = 0;
    if (value !== undefined) reflectionMergePartial<HostedService_Upstream>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: HostedService_Upstream
  ): HostedService_Upstream {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: HostedService_Upstream,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string host = 1; */
...
class ConnectionState$Type extends MessageType<ConnectionState> {
  constructor() {
    super('octelium.api.main.user.v1.ConnectionState', [
      ...
      { no: 6, name: 'dns', kind: 'message', T: () => DNS },
      {
        ...
        kind: 'message',
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: () => ConnectionState_ServiceConfig,
      },
      {
        no: 8,
        name: 'l3Mode',
        kind: 'enum',
        T: () => ['octelium.api.main.user.v1.ConnectionState.L3Mode', ConnectionState_L3Mode],
      },
  ...
  create(value?: PartialMessage<ConnectionState>): ConnectionState {
    ...
    message.l3Mode = 0;
    if (value !== undefined) reflectionMergePartial<ConnectionState>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        ...
        case /* repeated octelium.api.main.meta.v1.DualStackNetwork addresses */ 4:
          message.addresses.push(
            DualStackNetwork.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        ...
        case /* repeated octelium.api.main.user.v1.ConnectionState.ServiceConfig serviceConfigs */ 7:
          message.serviceConfigs.push(
            ConnectionState_ServiceConfig.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        ...
        case /* octelium.api.main.user.v1.ConnectionState.ServiceOptions serviceOptions */ 9:
          message.serviceOptions = ConnectionState_ServiceOptions.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.serviceOptions
        ...
        case /* octelium.api.main.meta.v1.DualStackNetwork cidr */ 10:
          message.cidr = DualStackNetwork.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.cidr
  ...
  internalBinaryWrite(
    ...
    /* int32 mtu = 1; */
    if (message.mtu !== 0) writer.tag(1, WireType.Varint).int32(message.mtu);
    /* bytes x25519Key = 2; */
    if (message.x25519Key.length) writer.tag(2, WireType.LengthDelimited).bytes(message.x25519Key);
    /* bytes ed25519Key = 3; */
    ...
    for (let i = 0; i < message.addresses.length; i++)
      DualStackNetwork.internalBinaryWrite(
        message.addresses[i],
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    for (let i = 0; i < message.serviceConfigs.length; i++)
      ConnectionState_ServiceConfig.internalBinaryWrite(
        message.serviceConfigs[i],
        writer.tag(7, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* octelium.api.main.user.v1.ConnectionState.L3Mode l3Mode = 8; */
    if (message.l3Mode !== 0) writer.tag(8, WireType.Varint).int32(message.l3Mode);
    /* octelium.api.main.user.v1.ConnectionState.ServiceOptions serviceOptions = 9; */
    if (message.serviceOptions)
      ConnectionState_ServiceOptions.internalBinaryWrite(
        message.serviceOptions,
...
class ConnectionState_ServiceOptions$Type extends MessageType<ConnectionState_ServiceOptions> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectionState_ServiceOptions
  ): ConnectionState_ServiceOptions {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectionState_ServiceOptions,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* repeated octelium.api.main.user.v1.HostedService services = 1; */
    for (let i = 0; i < message.services.length; i++)
      HostedService.internalBinaryWrite(
        message.services[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class ConnectionState_ServiceConfig$Type extends MessageType<ConnectionState_ServiceConfig> {
    ...
    super('octelium.api.main.user.v1.ConnectionState.ServiceConfig', [
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => ConnectionState_ServiceConfig_SSH,
      },
    ]);
  }
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectionState_ServiceConfig
  ): ConnectionState_ServiceConfig {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* octelium.api.main.user.v1.ConnectionState.ServiceConfig.SSH ssh */ 1:
          message.type = {
            oneofKind: 'ssh',
            ssh: ConnectionState_ServiceConfig_SSH.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).ssh
            ),
          };
          break;
        default:
...
class ConnectionState_ServiceConfig_SSH$Type extends MessageType<ConnectionState_ServiceConfig_SSH> {
  ...
  create(
    value?: PartialMessage<ConnectionState_ServiceConfig_SSH>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectionState_ServiceConfig_SSH
  ): ConnectionState_ServiceConfig_SSH {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: ConnectionState_ServiceConfig_SSH,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
...
class Service$Type extends MessageType<Service> {
  ...
  create(value?: PartialMessage<Service>): Service {
    ...
    message.apiVersion = '';
    message.kind = '';
    if (value !== undefined) reflectionMergePartial<Service>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.Service.Spec spec */ 4:
          message.spec = Service_Spec.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.spec
        ...
        case /* octelium.api.main.user.v1.Service.Status status */ 5:
          message.status = Service_Status.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status
  ...
  internalBinaryWrite(
    ...
    if (message.spec)
      Service_Spec.internalBinaryWrite(
        message.spec,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.status)
      Service_Status.internalBinaryWrite(
        message.status,
        writer.tag(5, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class Service_Spec$Type extends MessageType<Service_Spec> {
  constructor() {
    super('octelium.api.main.user.v1.Service.Spec', [
      { no: 1, name: 'port', kind: 'scalar', T: 13 /*ScalarType.UINT32*/ },
      {
        ...
        name: 'type',
        kind: 'enum',
        T: () => ['octelium.api.main.user.v1.Service.Spec.Type', Service_Spec_Type],
      },
  ...
  create(value?: PartialMessage<Service_Spec>): Service_Spec {
    ...
    if (value !== undefined) reflectionMergePartial<Service_Spec>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* bool isTLS = 3; */
    if (message.isTLS !== false) writer.tag(3, WireType.Varint).bool(message.isTLS);
    /* bool isPublic = 4; */
    if (message.isPublic !== false) writer.tag(4, WireType.Varint).bool(message.isPublic);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Service_Status$Type extends MessageType<Service_Status> {
  ...
  create(value?: PartialMessage<Service_Status>): Service_Status {
    ...
    if (value !== undefined) reflectionMergePartial<Service_Status>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ServiceList$Type extends MessageType<ServiceList> {
  ...
  create(value?: PartialMessage<ServiceList>): ServiceList {
    ...
    message.kind = '';
    message.items = [];
    if (value !== undefined) reflectionMergePartial<ServiceList>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ListServiceOptions$Type extends MessageType<ListServiceOptions> {
  ...
  create(value?: PartialMessage<ListServiceOptions>): ListServiceOptions {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.namespace = '';
    if (value !== undefined) reflectionMergePartial<ListServiceOptions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.meta.v1.CommonListOptions common */ 1:
          message.common = CommonListOptions.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.common
  ...
  internalBinaryWrite(
    ...
    if (message.common)
      CommonListOptions.internalBinaryWrite(
        message.common,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class ListNamespaceOptions$Type extends MessageType<ListNamespaceOptions> {
  ...
  create(value?: PartialMessage<ListNamespaceOptions>): ListNamespaceOptions {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<ListNamespaceOptions>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Namespace$Type extends MessageType<Namespace> {
  ...
  create(value?: PartialMessage<Namespace>): Namespace {
    ...
    message.apiVersion = '';
    message.kind = '';
    if (value !== undefined) reflectionMergePartial<Namespace>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* octelium.api.main.user.v1.Namespace.Spec spec */ 4:
          message.spec = Namespace_Spec.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.spec
        ...
        case /* octelium.api.main.user.v1.Namespace.Status status */ 5:
          message.status = Namespace_Status.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status
  ...
  internalBinaryWrite(
    ...
    if (message.spec)
      Namespace_Spec.internalBinaryWrite(
        message.spec,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options
      ).join();
    ...
    if (message.status)
      Namespace_Status.internalBinaryWrite(
        message.status,
        writer.tag(5, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class Namespace_Spec$Type extends MessageType<Namespace_Spec> {
  ...
  create(value?: PartialMessage<Namespace_Spec>): Namespace_Spec {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<Namespace_Spec>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Namespace_Status$Type extends MessageType<Namespace_Status> {
  ...
  create(value?: PartialMessage<Namespace_Status>): Namespace_Status {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<Namespace_Status>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class NamespaceList$Type extends MessageType<NamespaceList> {
  ...
  create(value?: PartialMessage<NamespaceList>): NamespaceList {
    ...
    message.kind = '';
    message.items = [];
    if (value !== undefined) reflectionMergePartial<NamespaceList>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ConnectResponse$Type extends MessageType<ConnectResponse> {
  constructor() {
    super('octelium.api.main.user.v1.ConnectResponse', [
      ...
      },
      {
        ...
        kind: 'message',
        oneof: 'event',
        T: () => ConnectResponse_UpdateGateway,
      },
      {
        no: 3,
        name: 'deleteGateway',
        kind: 'message',
        oneof: 'event',
        T: () => ConnectResponse_DeleteGateway,
      },
      {
        no: 4,
        name: 'updateDNS',
      ...
      },
      {
        ...
        kind: 'message',
        oneof: 'event',
        T: () => ConnectResponse_UpdateService,
      },
      {
        no: 9,
        name: 'deleteService',
        kind: 'message',
        oneof: 'event',
        T: () => ConnectResponse_DeleteService,
      },
  ...
  create(value?: PartialMessage<ConnectResponse>): ConnectResponse {
    ...
    if (value !== undefined) reflectionMergePartial<ConnectResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.user.v1.ConnectResponse.AddGateway addGateway */ 1:
          message.event = {
            oneofKind: 'addGateway',
            addGateway: ConnectResponse_AddGateway.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).addGateway
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.UpdateGateway updateGateway */ 2:
          message.event = {
            oneofKind: 'updateGateway',
            updateGateway: ConnectResponse_UpdateGateway.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).updateGateway
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.DeleteGateway deleteGateway */ 3:
          message.event = {
            oneofKind: 'deleteGateway',
            deleteGateway: ConnectResponse_DeleteGateway.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).deleteGateway
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.UpdateDNS updateDNS */ 4:
          message.event = {
            oneofKind: 'updateDNS',
            updateDNS: ConnectResponse_UpdateDNS.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).updateDNS
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.Message message */ 5:
          message.event = {
            oneofKind: 'message',
            message: ConnectResponse_Message.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
        ...
        case /* octelium.api.main.user.v1.ConnectResponse.Disconnect disconnect */ 6:
          message.event = {
            oneofKind: 'disconnect',
            disconnect: ConnectResponse_Disconnect.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).disconnect
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.AddService addService */ 7:
          message.event = {
            oneofKind: 'addService',
            addService: ConnectResponse_AddService.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).addService
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.UpdateService updateService */ 8:
          message.event = {
            oneofKind: 'updateService',
            updateService: ConnectResponse_UpdateService.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).updateService
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectResponse.DeleteService deleteService */ 9:
          message.event = {
            oneofKind: 'deleteService',
            deleteService: ConnectResponse_DeleteService.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).deleteService
            ),
          };
          break;
        case /* octelium.api.main.user.v1.ConnectionState state */ 10:
          message.event = {
            oneofKind: 'state',
            state: ConnectionState.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.event as any).state
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.event.oneofKind === 'disconnect')
      ConnectResponse_Disconnect.internalBinaryWrite(
...
class ConnectResponse_AddGateway$Type extends MessageType<ConnectResponse_AddGateway> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_AddGateway
  ): ConnectResponse_AddGateway {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* octelium.api.main.user.v1.Gateway gateway */ 1:
          message.gateway = Gateway.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gateway
  ...
  internalBinaryWrite(
    message: ConnectResponse_AddGateway,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
...
class ConnectResponse_UpdateGateway$Type extends MessageType<ConnectResponse_UpdateGateway> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_UpdateGateway
  ): ConnectResponse_UpdateGateway {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectResponse_UpdateGateway,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.user.v1.Gateway gateway = 1; */
...
class ConnectResponse_DeleteGateway$Type extends MessageType<ConnectResponse_DeleteGateway> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_DeleteGateway
  ): ConnectResponse_DeleteGateway {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectResponse_DeleteGateway,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string id = 1; */
...
class ConnectResponse_Disconnect$Type extends MessageType<ConnectResponse_Disconnect> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_Disconnect
  ): ConnectResponse_Disconnect {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectResponse_Disconnect,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string message = 1; */
...
class ConnectResponse_Message$Type extends MessageType<ConnectResponse_Message> {
  ...
  create(value?: PartialMessage<ConnectResponse_Message>): ConnectResponse_Message {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.message = '';
    if (value !== undefined) reflectionMergePartial<ConnectResponse_Message>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_Message
...
class ConnectResponse_UpdateDNS$Type extends MessageType<ConnectResponse_UpdateDNS> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_UpdateDNS
  ): ConnectResponse_UpdateDNS {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectResponse_UpdateDNS,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
...
class ConnectResponse_AddService$Type extends MessageType<ConnectResponse_AddService> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_AddService
  ): ConnectResponse_AddService {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* octelium.api.main.user.v1.HostedService service */ 1:
          message.service = HostedService.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.service
  ...
  internalBinaryWrite(
    message: ConnectResponse_AddService,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
...
class ConnectResponse_UpdateService$Type extends MessageType<ConnectResponse_UpdateService> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_UpdateService
  ): ConnectResponse_UpdateService {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectResponse_UpdateService,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.user.v1.HostedService service = 1; */
...
class ConnectResponse_DeleteService$Type extends MessageType<ConnectResponse_DeleteService> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ConnectResponse_DeleteService
  ): ConnectResponse_DeleteService {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: ConnectResponse_DeleteService,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string name = 1; */
...
class SetServiceConfigsRequest$Type extends MessageType<SetServiceConfigsRequest> {
  ...
  create(value?: PartialMessage<SetServiceConfigsRequest>): SetServiceConfigsRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.name = '';
    if (value !== undefined) reflectionMergePartial<SetServiceConfigsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SetServiceConfigsRequest
...
class SetServiceConfigsResponse$Type extends MessageType<SetServiceConfigsResponse> {
    ...
    super('octelium.api.main.user.v1.SetServiceConfigsResponse', [
      {
        ...
        kind: 'message',
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: () => SetServiceConfigsResponse_Config,
      },
    ]);
  }
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SetServiceConfigsResponse
      ...
      switch (fieldNo) {
        case /* repeated octelium.api.main.user.v1.SetServiceConfigsResponse.Config configs */ 1:
          message.configs.push(
            SetServiceConfigsResponse_Config.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.configs.length; i++)
      SetServiceConfigsResponse_Config.internalBinaryWrite(
        message.configs[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
...
class SetServiceConfigsResponse_Config$Type extends MessageType<SetServiceConfigsResponse_Config> {
    ...
    super('octelium.api.main.user.v1.SetServiceConfigsResponse.Config', [
      {
        ...
        kind: 'message',
        oneof: 'type',
        T: () => SetServiceConfigsResponse_Config_Kubeconfig,
      },
    ]);
  }
  create(
    value?: PartialMessage<SetServiceConfigsResponse_Config>
  ): SetServiceConfigsResponse_Config {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.type = { oneofKind: undefined };
    if (value !== undefined)
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SetServiceConfigsResponse_Config
  ): SetServiceConfigsResponse_Config {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* octelium.api.main.user.v1.SetServiceConfigsResponse.Config.Kubeconfig kubeconfig */ 1:
          message.type = {
            oneofKind: 'kubeconfig',
            kubeconfig: SetServiceConfigsResponse_Config_Kubeconfig.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).kubeconfig
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    message: SetServiceConfigsResponse_Config,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* octelium.api.main.user.v1.SetServiceConfigsResponse.Config.Kubeconfig kubeconfig = 1; */
    if (message.type.oneofKind === 'kubeconfig')
      SetServiceConfigsResponse_Config_Kubeconfig.internalBinaryWrite(
        message.type.kubeconfig,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
...
class SetServiceConfigsResponse_Config_Kubeconfig$Type extends MessageType<SetServiceConfigsResponse_Config_Kubeconfig> {
  ...
  create(
    value?: PartialMessage<SetServiceConfigsResponse_Config_Kubeconfig>
  ): SetServiceConfigsResponse_Config_Kubeconfig {
    const message = globalThis.Object.create(this.messagePrototype!);
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SetServiceConfigsResponse_Config_Kubeconfig
  ): SetServiceConfigsResponse_Config_Kubeconfig {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
  ...
  internalBinaryWrite(
    message: SetServiceConfigsResponse_Config_Kubeconfig,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* bytes content = 1; */
 ...
 */
export const SetServiceConfigsResponse_Config_Kubeconfig =
  new SetServiceConfigsResponse_Config_Kubeconfig$Type();
/**
...
export const MainService = new ServiceType('octelium.api.main.user.v1.MainService', [
  ...
  {
    name: 'SetServiceConfigs',
    options: {},
    I: SetServiceConfigsRequest,
    O: SetServiceConfigsResponse,
  },
]);
