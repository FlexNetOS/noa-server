...
export const ResourceListWrapper = (props: { children?: React.ReactNode }) => {
  return <div className="flex w-full flex-col">{props.children}</div>;
};

export const ResourceListItem = (props: { children?: React.ReactNode; path?: string }) => {
...
export const ResourceListLabel = (props: {
  ...
  return props.to ? (
    <Link to={props.to}>
      <Label>
        {props.label && <span className="mr-1 text-blue-300">{props.label}</span>}
