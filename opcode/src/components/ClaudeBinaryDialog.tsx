        ...
        <DialogHeader>
          ...
          <DialogDescription className="mt-4 space-y-3">
            {checkingInstallations ? (
              ...
              <p>
                Multiple Claude Code installations were found on your system. Please select which
                one you'd like to use.
              </p>
            ) : (
              <>
                <p>
                  Claude Code was not found in any of the common installation locations. Please
