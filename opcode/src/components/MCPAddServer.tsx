            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="font-mono"
                />
                <p className="text-muted-foreground text-xs">The command to execute the server</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="font-mono"
                />
                <p className="text-muted-foreground text-xs">Space-separated command arguments</p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="font-mono"
                />
                <p className="text-muted-foreground text-xs">The SSE endpoint URL</p>
              </div>
