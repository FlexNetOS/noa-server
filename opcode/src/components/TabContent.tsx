...
const AgentExecution = lazy(() =>
  import('@/components/AgentExecution').then((m) => ({ default: m.AgentExecution }))
);
                ...
                <div className="mx-auto max-w-6xl p-6">
                  ...
                  {error && (
                    <motion.div
                      ...
                      className="border-destructive/50 bg-destructive/10 text-destructive mb-4 rounded-lg border p-3 text-xs"
                    >
                      {error}
                    </motion.div>
                  )}
      ...
      {tabs.length === 0 && (
        <div className="text-muted-foreground flex h-full items-center justify-center">
          <div className="text-center">
            <p className="mb-2 text-lg">No projects open</p>
            <p className="mb-4 text-sm">Click to start a new project</p>
