        ...
        <CardContent className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex-1 space-y-3">
              ...
              {/* Session ID */}
              <div className="text-muted-foreground/60 font-mono text-xs">ID: {session.id}</div>
            </div>
...
export const SessionList: React.FC<SessionListProps> = React.memo(
  ({ sessions, projectPath, onBack, onSessionClick, onEditClaudeFile, className }) => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">{projectPath}</p>
            </div>
          </div>
