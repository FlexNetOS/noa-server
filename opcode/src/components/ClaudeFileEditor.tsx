      ...
      <div className="mx-auto flex h-full w-full max-w-5xl flex-col">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="truncate text-lg font-semibold">{file.relative_path}</h2>
        ...
        {error && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="border-destructive/50 bg-destructive/10 text-destructive mx-4 mt-4 rounded-lg border p-3 text-xs"
          >
            {error}
          </motion.div>
        )}
