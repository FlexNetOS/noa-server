...
import { Plus, Trash2, Save, AlertCircle, Loader2, Shield, Check } from 'lucide-react';
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              className="bg-destructive/10 border-destructive/50 text-body-small text-destructive mx-4 mt-4 flex items-center gap-2 rounded-lg border p-3"
            >
        ...
        {loading ? (
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="mb-6 grid h-auto w-full grid-cols-8 p-1">
                <TabsTrigger value="general" className="px-3 py-2.5">
                  General
                </TabsTrigger>
                <TabsTrigger value="permissions" className="px-3 py-2.5">
                  Permissions
                </TabsTrigger>
                <TabsTrigger value="environment" className="px-3 py-2.5">
                  Environment
                </TabsTrigger>
                <TabsTrigger value="advanced" className="px-3 py-2.5">
                  Advanced
                </TabsTrigger>
                <TabsTrigger value="hooks" className="px-3 py-2.5">
                  Hooks
                </TabsTrigger>
                <TabsTrigger value="commands" className="px-3 py-2.5">
                  Commands
                </TabsTrigger>
                <TabsTrigger value="storage" className="px-3 py-2.5">
                  Storage
                </TabsTrigger>
                <TabsTrigger value="proxy" className="px-3 py-2.5">
                  Proxy
                </TabsTrigger>
              </TabsList>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-muted/20 space-y-4 rounded-lg border p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                              <Label htmlFor="color-background" className="text-caption">
                                Background
                              </Label>
                            ...
                            {/* Foreground Color */}
                            <div className="space-y-2">
                              <Label htmlFor="color-foreground" className="text-caption">
                                Foreground
                              </Label>
                              <div className="flex gap-2">
                                <Input
                            ...
                            {/* Primary Color */}
                            <div className="space-y-2">
                              <Label htmlFor="color-primary" className="text-caption">
                                Primary
                              </Label>
                              <div className="flex gap-2">
                                <Input
                            ...
                            {/* Card Color */}
                            <div className="space-y-2">
                              <Label htmlFor="color-card" className="text-caption">
                                Card
                              </Label>
                              <div className="flex gap-2">
                                <Input
                            ...
                            {/* Accent Color */}
                            <div className="space-y-2">
                              <Label htmlFor="color-accent" className="text-caption">
                                Accent
                              </Label>
                              <div className="flex gap-2">
                                <Input
                            ...
                            {/* Destructive Color */}
                            <div className="space-y-2">
                              <Label htmlFor="color-destructive" className="text-caption">
                                Destructive
                              </Label>
                              <div className="flex gap-2">
                                <Input
                      ...
                      <div className="space-y-3">
                        ...
                        />
                        {binaryPathChanged && (
                          <p className="text-caption flex items-center gap-1 text-amber-600 dark:text-amber-400">
                ...
                <Card className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2 pt-2">
                      ...
                      <ul className="text-caption text-muted-foreground ml-4 space-y-1">
                        <li>
                          •{' '}
                          <code className="rounded bg-green-500/10 px-1 py-0.5 text-green-600 dark:text-green-400">
                            Bash
                          </code>{' '}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2 pt-2">
                      ...
                      <ul className="text-caption text-muted-foreground ml-4 space-y-1">
                        <li>
                          •{' '}
                          <code className="rounded bg-blue-500/10 px-1 py-0.5 text-blue-600 dark:text-blue-400">
              ...
              <TabsContent value="advanced" className="space-y-6">
                <Card className="p-6">
                  <div className="space-y-6">
                    <div>
                      <h3 className="mb-4 text-base font-semibold">Advanced Settings</h3>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-muted overflow-x-auto rounded-md p-3 font-mono text-xs whitespace-pre-wrap">
              ...
              <TabsContent value="hooks" className="space-y-6">
                <Card className="p-6">
                  <div className="space-y-4">
                    <div>
                      <h3 className="mb-2 text-base font-semibold">User Hooks</h3>
                      <p className="text-body-small text-muted-foreground mb-4">
                        Configure hooks that apply to all Claude Code sessions for your user
                        account. These are stored in{' '}
