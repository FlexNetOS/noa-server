        ...
        >
          ...
          >
            ...
            <div className="relative flex items-center justify-center">
              ...
              >
                <motion.div
                  className="bg-primary/15 absolute inset-0 rounded-full blur-2xl"
                  initial={{ opacity: 0 }}
...
function BrandText() {
  return (
    <div className="brand-text text-5xl font-extrabold tracking-tight">
      <span className="brand-text-solid">opcode</span>
      <span aria-hidden="true" className="brand-text-shimmer">
        opcode
      </span>
    </div>
  );
