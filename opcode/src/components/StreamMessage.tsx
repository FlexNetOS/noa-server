                    ...
                    if (content.type === 'tool_use') {
                      ...
                      return (
                        <div key={idx} className="space-y-2">
                          ...
                          {content.input && (
                            <div className="bg-background ml-6 rounded-md border p-2">
                      ...
                      if (!contentText || contentText.trim() === '') {
                        ...
                        return (
                          <div key={idx} className="space-y-2">
                            ...
                            <div className="bg-muted/50 text-muted-foreground ml-6 rounded-md border p-3 text-sm italic">
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                {message.error && <div className="text-destructive text-sm">{message.error}</div>}
