...
function AppContent() {
  ...
  const { createClaudeMdTab, createSettingsTab, createUsageTab, createMCPTab, createAgentsTab } =
    useTabState();
          ...
          default:
            ...
            if (e.key >= '1' && e.key <= '9') {
              ...
              window.dispatchEvent(
                new CustomEvent('switch-to-tab-by-index', { detail: { index } })
              );
            }
            break;
        }
          ...
          <div className="flex items-center justify-center p-4" style={{ height: '100%' }}>
            <div className="w-full max-w-4xl">
              ...
              <div className="mx-auto grid max-w-2xl grid-cols-1 gap-6 md:grid-cols-2">
                ...
                >
                  <Card
                    className="border-border/50 shimmer-hover trailing-border h-64 cursor-pointer border transition-all duration-200 hover:scale-105 hover:shadow-lg"
                    onClick={() => handleViewChange('cc-agents')}
                  >
                    <div className="flex h-full flex-col items-center justify-center p-8">
                      <Bot className="text-primary mb-4 h-16 w-16" />
                ...
                >
                  ...
                  >
                    <div className="flex h-full flex-col items-center justify-center p-8">
                      <FolderCode className="text-primary mb-4 h-16 w-16" />
    ...
    <div className="flex h-screen flex-col">
      ...
      {showProjectPicker && (
        <div className="bg-background/80 fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
          <div className="bg-background h-[600px] w-full max-w-2xl rounded-lg border shadow-lg">
            <FilePicker
