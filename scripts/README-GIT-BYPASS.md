...
This directory contains scripts to bypass the git operation blocking implemented by the Truth Verification System.
...
2. Exported bash function (`function git() { /usr/local/bin/git-blocked "$@"; }`)
...
The Truth Verification System's core validation remains active. Only git blocking has been bypassed.
