...
class EndToEndTests {
    static run(runner) {
        ...
        runner.addTest('E2E - Environment validation', async () => {
        ...
        runner.addTest('E2E - Port availability check', async () => {
            const { EnvironmentInitializer, Logger } = require('./init-controller');
        ...
        runner.addTest('E2E - Service health check', async () => {
            const port = 65433;
...
class PerformanceTests {
    static run(runner) {
        ...
        runner.addTest('Performance - Initialization speed', async () => {
            const {
                InitializationController,
                InitializationBuilder,
                StandardInitializationStrategy,
        ...
        // Memory usage test
        runner.addTest('Performance - Memory usage', async () => {
