...
export const metadata: Metadata = {
  ...
  description:
    'A terminal app that manages multiple AI code assistants (Claude Code, Codex, Aider, etc.) in separate workspaces, allowing you to work on multiple tasks simultaneously.',
  keywords: [
    'claude',
    'claude squad',
    'ai',
