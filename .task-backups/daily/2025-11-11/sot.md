...
- [Master File Directory](#master-file-directory)
- [Completed Tasks Archive](#completed-tasks-archive)
...
- **Contributing Guide**: `/docs/guides/CONTRIBUTING.md` → [View](../../docs/guides/CONTRIBUTING.md)
- **Security Policy**: `/docs/SECURITY.md` → [View](../../docs/SECURITY.md)
...
| **DR**    | Disaster Recovery                  | Business continuity plan         | [Runbook](../../docs/runbooks/BACKUP_RESTORE.md) |
| **IaC**   | Infrastructure as Code             | Terraform configurations         | [Terraform](../../terraform/)    |
...
| **SOP**   | Standard Operating Procedures      | Process documentation            | [SOP](./sop.md)                                 |
...
| **Orchestration** | Task management system           | `/.orchestration/docs/current.todo`, `/.orchestration/docs/backlog.todo`  | Product Team |
...
**Critical Security Updates**: 0 **Minor Updates Available**: 12 **Last Full Audit**: 2025-10-22 **Next Scheduled Audit**: 2025-10-29
...
_Auto-updated via monitoring integrations and manual updates._ **Last Updated:** 2025-10-22 23:55 UTC  **Next Auto-Update:** 2025-10-23 00:00 UTC  **Document Owner:** Engineering Team  **Review Frequency:** Weekly
