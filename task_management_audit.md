...
**Your Definition:** Pending tasks for immediate execution in chronological order
...
## Example Entry
- [ ] [P1] Fix authentication bug in login flow @backend #security due:2025-01-10
...
**Your Definition:** Development, deployment, architecture, backup, recovery, file organization, goals
...
**Your Definition:** Completed tasks, file directory, pointers, glossary, current health/status
