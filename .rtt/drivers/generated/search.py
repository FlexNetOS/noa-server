...
class Connector:
    """Connector for rtt://mcp/claude/tool/search@1.0.0"""

    def __init__(self):
        self.symbol_address = "rtt://mcp/claude/tool/search@1.0.0"
    ...
    def health(self, handle: Any) -> Dict[str, Any]:
        ...
        """
        return {'ok': True, 'symbol': 'rtt://mcp/claude/tool/search@1.0.0'}
