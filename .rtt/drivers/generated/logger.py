...
class Connector:
    """Connector for rtt://obs/extension/logger@1.3.0#ndjson"""

    def __init__(self):
        self.symbol_address = "rtt://obs/extension/logger@1.3.0#ndjson"
    ...
    def health(self, handle: Any) -> Dict[str, Any]:
        ...
        """
        return {'ok': True, 'symbol': 'rtt://obs/extension/logger@1.3.0#ndjson'}
