    ...
    navigator.clipboard
      ...
      .then(() => {
        ...
        notification.style.cssText =
          'position:fixed;top:20px;right:20px;background:#4CAF50;color:white;padding:10px;border-radius:4px;z-index:9999;';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (headerSource) {
    ...
    button.style.cssText =
      'background:none;border:1px solid #ddd;padding:6px 12px;margin-right:8px;border-radius:4px;cursor:pointer;';
