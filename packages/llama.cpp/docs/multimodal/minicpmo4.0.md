...
Download [MiniCPM-o-4](https://huggingface.co/openbmb/MiniCPM-o-4) PyTorch model
from huggingface to "MiniCPM-o-4" folder.
...
[gguf](https://huggingface.co/openbmb/MiniCPM-o-4-gguf) by us)
