...
Download [MiniCPM-V-4](https://huggingface.co/openbmb/MiniCPM-V-4) PyTorch model
from huggingface to "MiniCPM-V-4" folder.
...
[gguf](https://huggingface.co/openbmb/MiniCPM-V-4-gguf) by us)
