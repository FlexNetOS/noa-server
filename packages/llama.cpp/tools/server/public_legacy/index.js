...
function s(t) {
  ...
  let n = t.n;
  if (void 0 === n || n.t !== _) {
    n = { i: 0, S: t, p: _.s, n: void 0, t: _, e: void 0, x: void 0, r: n };
...
function R(t, n, e) {
  ...
  if (
    (arguments.length > 2 && (r.children = arguments.length > 3 ? w.call(arguments, 2) : e),
    'function' == typeof t && null != t.defaultProps)
  )
    for (o in t.defaultProps) void 0 === r[o] && (r[o] = t.defaultProps[o]);
  return I(t, r, _, i, null);
}
function I(t, n, e, _, i) {
  var o = {
    type: t,
    props: n,
    key: e,
...
function B(t, n) {
  ...
  for (var e; n < t.__k.length; n++) if (null != (e = t.__k[n]) && null != e.__e) return e.__e;
...
function G(t) {
  ((!t.__d && (t.__d = !0) && U.push(t) && !J.__r++) || E !== S.debounceRendering) &&
    ((E = S.debounceRendering) || H)(J);
}
function J() {
  var t, n, e, _, i, o, r, u;
  for (U.sort(P); (t = U.shift()); )
    t.__d &&
      ((n = U.length),
      (_ = void 0),
      (o = (i = (e = t).__v).__e),
...
function K(t, n, e, _, i, o, r, u, l, s, f) {
  ...
  for (e.__d = l, Q(e, n, v), l = e.__d, c = 0; c < y; c++)
    null != (a = e.__k[c]) &&
      ((h = -1 === a.__i ? M : v[a.__i] || M),
      (a.__i = c),
      _t(t, a, h, i, o, r, u, l, s, f),
      (p = a.__e),
      a.ref && h.ref != a.ref && (h.ref && rt(h.ref, null, a), f.push(a.ref, a.__c || p, a)),
      null == d && null != p && (d = p),
      ...
      ? ((r = _ + c),
        ((i = t.__k[_] =
          ...
          i.constructor == String
            ? I(null, i, null, null, null)
            : W(i)
              ? I(j, { children: i }, null, null, null)
              : void 0 === i.constructor && i.__b > 0
                ? I(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v)
                : i).__ = t),
        (i.__b = t.__b + 1),
        (o = null),
        -1 !== (u = i.__i = Z(i, e, r, f)) && (f--, (o = e[u]) && (o.__u |= 131072)),
        null == o || null === o.__v
          ? (-1 == u && c--, 'function' != typeof i.type && (i.__u |= 65536))
          : u !== r &&
            (u == r - 1 ? c-- : u == r + 1 ? c++ : (u > r ? c-- : c++, (i.__u |= 65536))))
      : (i = t.__k[_] = null);
  if (f)
    for (_ = 0; _ < s; _++)
      null != (o = e[_]) && 0 == (131072 & o.__u) && (o.__e == t.__d && (t.__d = B(o)), ut(o, o));
}
function X(t, n, e) {
  var _, i;
  if ('function' == typeof t.type) {
    for (_ = t.__k, i = 0; _ && i < _.length; i++) _[i] && ((_[i].__ = t), (n = X(_[i], n, e)));
    return n;
  }
  t.__e != n &&
    (n && t.type && !e.contains(n) && (n = B(t)), e.insertBefore(t.__e, n || null), (n = t.__e));
  do {
    n = n && n.nextSibling;
...
function Z(t, n, e, _) {
  var i = t.key,
    ...
    u = e + 1,
    l = n[e];
  if (null === l || (l && i == l.key && o === l.type && 0 == (131072 & l.__u))) return e;
  if (_ > (null != l && 0 == (131072 & l.__u) ? 1 : 0))
    for (; r >= 0 || u < n.length; ) {
      if (r >= 0) {
        if ((l = n[r]) && 0 == (131072 & l.__u) && i == l.key && o === l.type) return r;
        r--;
      }
      if (u < n.length) {
        if ((l = n[u]) && 0 == (131072 & l.__u) && i == l.key && o === l.type) return u;
        u++;
      }
    }
  return -1;
...
function tt(t, n, e) {
  '-' === n[0]
    ...
    : (t[n] = null == e ? '' : 'number' != typeof e || F.test(n) ? e : e + 'px');
}
  ...
  t: if ('style' === n)
    ...
    ((o = n !== (n = n.replace(/(PointerCapture)$|Capture$/i, '$1'))),
      ...
      e
        ? _
          ? (e.u = _.u)
          : ((e.u = N), t.addEventListener(n, o ? T : $, o))
        : t.removeEventListener(n, o ? T : $, o));
  else {
    if ('http://www.w3.org/2000/svg' == i) n = n.replace(/xlink(H|:h)/, 'h').replace(/sName$/, 's');
    else if (
      'width' != n &&
      'height' != n &&
      'href' != n &&
    ...
    'function' == typeof e ||
      (null == e || (!1 === e && '-' !== n[4])
        ? t.removeAttribute(n)
        : t.setAttribute(n, 'popover' == n && 1 == e ? '' : e));
  }
}
function et(t) {
  return function (n) {
...
function _t(t, n, e, _, i, o, r, u, l, s) {
  ...
  (128 & e.__u && ((l = !!(32 & e.__u)), (o = [(u = n.__e = e.__e)])), (f = S.__b) && f(n));
  t: if ('function' == typeof E)
    try {
      if (
        ((y = n.props),
        (m = 'prototype' in E && E.prototype.render),
        (g = (f = E.contextType) && _[f.__c]),
        (b = f ? (g ? g.props.value : f.__) : _),
        e.__c
          ? (v = (c = n.__c = e.__c).__ = c.__E)
          : (m
              ? (n.__c = c = new E(y, b))
              : ((n.__c = c = new q(y, b)), (c.constructor = E), (c.render = lt)),
            g && g.sub(c),
            (c.props = y),
            c.state || (c.state = {}),
            (c.context = b),
            ...
            (c.__h = []),
            (c._sb = [])),
        m && null == c.__s && (c.__s = c.state),
        m &&
          null != E.getDerivedStateFromProps &&
          (c.__s == c.state && (c.__s = L({}, c.__s)),
          L(c.__s, E.getDerivedStateFromProps(y, c.__s))),
        (a = c.props),
        (p = c.state),
        (c.__v = n),
        h)
        ...
        (m &&
          ...
          m && null != c.componentDidMount && c.__h.push(c.componentDidMount));
      else {
        if (
          (m &&
            null == E.getDerivedStateFromProps &&
          ...
          !c.__e &&
            ((null != c.shouldComponentUpdate && !1 === c.shouldComponentUpdate(y, c.__s, b)) ||
              n.__v === e.__v))
        ) {
          for (
      ...
      if (((c.context = b), (c.props = y), (c.__P = t), (c.__e = !1), (w = S.__r), (x = 0), m)) {
        for (
          c.state = c.__s, c.__d = !1, w && w(n), f = c.render(c.props, c.state, c.context), C = 0;
          C < c._sb.length;
          C++
        )
          c.__h.push(c._sb[C]);
        ...
        do {
          ((c.__d = !1), w && w(n), (f = c.render(c.props, c.state, c.context)), (c.state = c.__s));
        } while (c.__d && ++x < 25);
      ((c.state = c.__s),
        null != c.getChildContext && (_ = L(L({}, _), c.getChildContext())),
        m && !h && null != c.getSnapshotBeforeUpdate && (d = c.getSnapshotBeforeUpdate(a, p)),
        K(
          t,
          W((U = null != f && f.type === j && null == f.key ? f.props.children : f)) ? U : [U],
          n,
          e,
          _,
          i,
      ...
      if (((n.__v = null), l || null != o)) {
        for (n.__u |= l ? 160 : 128; u && 8 === u.nodeType && u.nextSibling; ) u = u.nextSibling;
        ((o[o.indexOf(u)] = null), (n.__e = u));
      } else ((n.__e = e.__e), (n.__k = e.__k));
      S.__e(t, n, e);
    }
  else
    null == o && n.__v === e.__v
...
function ot(t, n, e, _, i, o, r, u, l) {
  ...
  if (null == t) {
    ...
    ((t = document.createElementNS(i, m, y.is && y)),
      u && (S.__m && S.__m(n, o), (u = !1)),
      (o = null));
  }
  if (null === m) v === y || (u && t.data === y) || (t.data = y);
  else {
    if (((o = o && w.call(t.childNodes)), (v = e.props || M), !u && null != o))
      for (v = {}, s = 0; s < t.attributes.length; s++) v[(a = t.attributes[s]).name] = a.value;
    for (s in v)
      if (((a = v[s]), 'children' == s));
      else if ('dangerouslySetInnerHTML' == s) c = a;
      else if (!(s in y)) {
        if (('value' == s && 'defaultValue' in y) || ('checked' == s && 'defaultChecked' in y))
          continue;
        nt(t, s, null, a, i);
      }
    for (s in y)
        ...
        'children' == s
          ...
          : 'dangerouslySetInnerHTML' == s
            ...
            : 'value' == s
              ...
              : 'checked' == s
                ? (d = a)
                : (u && 'function' != typeof a) || v[s] === a || nt(t, s, a, v[s], i));
    if (f)
      (u || (c && (f.__html === c.__html || f.__html === t.innerHTML)) || (t.innerHTML = f.__html),
        (n.__k = []));
    else if (
      (c && (t.innerHTML = ''),
      K(
        ...
        e,
        _,
        'foreignObject' === m ? 'http://www.w3.org/1999/xhtml' : i,
        o,
        r,
        o ? o[0] : e.__k && B(e, 0),
        u,
      ...
      for (s = o.length; s--; ) O(o[s]);
    u ||
      ((s = 'value'),
      'progress' === m && null == p
        ? t.removeAttribute('value')
        : void 0 !== p &&
          (p !== t[s] || ('progress' === m && !p) || ('option' === m && p !== v[s])) &&
          nt(t, s, p, v[s], i),
      (s = 'checked'),
      void 0 !== d && d !== t[s] && nt(t, s, d, v[s], i));
  }
  return t;
}
function rt(t, n, e) {
...
function ut(t, n, e) {
  ...
  (e || O(t.__e), (t.__c = t.__ = t.__e = t.__d = void 0));
}
function lt(t, n, e) {
...
function st(t, n, e) {
  ...
  (S.__ && S.__(t, n),
    ...
    _t(
      n,
      (t = ((!_ && e) || n).__k = R(j, null, [t])),
      i || M,
      M,
      n.namespaceURI,
      !_ && e ? [e] : i ? null : n.firstChild ? w.call(n.childNodes) : null,
      o,
...
function ct(t, n, e) {
  ...
  return (
    arguments.length > 2 && (u.children = arguments.length > 3 ? w.call(arguments, 2) : e),
    I(t.type, u, _ || t.key, i || t.ref, null)
  );
}
function ht(t, n) {
  var e = {
...
((w = A.slice),
  ...
  (q.prototype.setState = function (t, n) {
    var e;
    ((e = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = L({}, this.state))),
      'function' == typeof t && (t = t(L({}, e), this.props)),
      t && L(e, t),
      null != t && this.__v && (n && this._sb.push(n), G(this)));
  }),
  ...
  (U = []),
  (H = 'function' == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
  (P = function (t, n) {
...
function Pt(t, n) {
  var e = Ut(at++, 3);
  !gt.__s && qt(e.__H, n) && ((e.__ = t), (e.i = n), pt.__H.__h.push(e));
}
function Nt(t, n) {
  var e = Ut(at++, 4);
  !gt.__s && qt(e.__H, n) && ((e.__ = t), (e.i = n), pt.__h.push(e));
}
function $t(t) {
  return (
    (yt = 5),
...
function Dt(t, n) {
  var e = Ut(at++, 7);
  return (qt(e.__H, n) && ((e.__ = t()), (e.__H = n), (e.__h = t)), e.__);
}
function Mt(t, n) {
  return (
    (yt = 8),
...
function Ft(t, n) {
  gt.useDebugValue && gt.useDebugValue(n ? n(t) : t);
}
function Wt(t) {
  var n = Ut(at++, 10),
    e = Et();
...
function Ot() {
  for (var t; (t = mt.shift()); )
    if (t.__P && t.__H)
      try {
        (t.__H.__h.forEach(Vt), t.__H.__h.forEach(jt), (t.__H.__h = []));
      } catch (n) {
        ((t.__H.__h = []), gt.__e(n, t.__v));
      }
}
((gt.__b = function (t) {
  ((pt = null), bt && bt(t));
  ...
  (gt.__ = function (t, n) {
    (t && n.__k && n.__k.__m && (t.__m = n.__k.__m), Ct && Ct(t, n));
  }),
  (gt.__r = function (t) {
    (kt && kt(t), (at = 0));
    var n = (pt = t.__c).__H;
    (n &&
      (dt === pt
        ...
        : (n.__h.forEach(Vt), n.__h.forEach(jt), (n.__h = []), (at = 0))),
      (dt = pt));
  }),
  (gt.diffed = function (t) {
    ...
    (n &&
      n.__H &&
      (n.__H.__h.length &&
        ((1 !== mt.push(n) && vt === gt.requestAnimationFrame) ||
          ((vt = gt.requestAnimationFrame) || It)(Ot)),
...
export {
  ...
  Nt as useLayoutEffect,
  Dt as useMemo,
  Ht as useReducer,
  $t as useRef,
  Yt as useSignal,
  tn as useSignalEffect,
  Et as useState,
};
