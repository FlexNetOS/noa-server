...
> [!IMPORTANT] [2024 Jun 12] Binaries have been renamed w/ a `llama-` prefix.
> `main` is now `llama-cli`, `server` is `llama-server`, etc
> (https://github.com/ggerganov/llama.cpp/pull/7809)

This migration was important, but it is a breaking change that may not always be
